...
exports.getRoleDefinitionsWithNormalizedId = function (roleDefinitions) {
  roleDefinitions.forEach(function (definition) {
    // Get guid as Id from fully qualified Id string
    definition.id = exports.getRoleDefinitionName(definition.id);
  });
