...
var JobOperations = ( /** @lends JobOperations */ function() {
   ...
   * 
   * @param {string} [parameters.job.errorMessage] Gets or sets the error
  ...
  JobOperations.prototype.build = function(resourceGroupName, accountName, parameters, callback) {
    ...
    if ('Azure SDK - Microsoft.Azure.Management.DataLake.AnalyticsJob 0.9.3-preview' + this.client.userAgentSuffix !== null && 'Azure SDK - Microsoft.Azure.Management.DataLake.AnalyticsJob 0.9.3-preview' + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['useragent'] = 'Azure SDK - Microsoft.Azure.Management.DataLake.AnalyticsJob 0.9.3-preview' + this.client.userAgentSuffix;
    }
    if ('Azure SDK - Microsoft.Azure.Management.DataLake.AnalyticsJob 0.9.3-preview' + this.client.userAgentSuffix !== null && 'Azure SDK - Microsoft.Azure.Management.DataLake.AnalyticsJob 0.9.3-preview' + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['User-Agent'] = 'Azure SDK - Microsoft.Azure.Management.DataLake.AnalyticsJob 0.9.3-preview' + this.client.userAgentSuffix;
    }
    if (resourceGroupName !== null && resourceGroupName !== undefined) {
    ...
    if (parameters.job !== null && parameters.job !== undefined) {
      ...
      if (parameters.job.stateAuditRecords !== null && parameters.job.stateAuditRecords !== undefined) {
        ...
        for (var loweredIndex1 = 0; loweredIndex1 < parameters.job.stateAuditRecords.length; loweredIndex1 = loweredIndex1 + 1) {
          var stateAuditRecordsItem = parameters.job.stateAuditRecords[loweredIndex1];
      ...
      if (parameters.job.properties.type === 'Hive') {
        ...
        if (derived.statementInfo !== null && derived.statementInfo !== undefined) {
          ...
          for (var loweredIndex2 = 0; loweredIndex2 < derived.statementInfo.length; loweredIndex2 = loweredIndex2 + 1) {
            var statementInfoItem = derived.statementInfo[loweredIndex2];
      ...
      if (parameters.job.properties.type === 'USql') {
        ...
        if (derived2.resources !== null && derived2.resources !== undefined) {
          var resourcesArray = [];
          for (var loweredIndex3 = 0; loweredIndex3 < derived2.resources.length; loweredIndex3 = loweredIndex3 + 1) {
            var resourcesItem = derived2.resources[loweredIndex3];
        ...
        if (derived2.diagnostics !== null && derived2.diagnostics !== undefined) {
          ...
          for (var loweredIndex4 = 0; loweredIndex4 < derived2.diagnostics.length; loweredIndex4 = loweredIndex4 + 1) {
            var diagnosticsItem = derived2.diagnostics[loweredIndex4];
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          var jobInstance = { stateAuditRecords: [] };
          ...
          var errorMessageValue = responseDoc['errorMessage'];
          if (errorMessageValue !== null && errorMessageValue !== undefined) {
            var errorMessageInstance = errorMessageValue;
          ...
          if (stateAuditRecordsArray2 !== null && stateAuditRecordsArray2 !== undefined) {
            for (var loweredIndex5 = 0; loweredIndex5 < stateAuditRecordsArray2.length; loweredIndex5 = loweredIndex5 + 1) {
              var stateAuditRecordsValue = stateAuditRecordsArray2[loweredIndex5];
              ...
              var detailsValue = stateAuditRecordsValue['details'];
          ...
          if (propertiesValue2 !== null && propertiesValue2 !== undefined) {
            ...
            if (typeName === 'Hive') {
              ...
              if (statementInfoArray2 !== null && statementInfoArray2 !== undefined) {
                for (var loweredIndex6 = 0; loweredIndex6 < statementInfoArray2.length; loweredIndex6 = loweredIndex6 + 1) {
                  var statementInfoValue = statementInfoArray2[loweredIndex6];
            ...
            if (typeName === 'USql') {
              ...
              if (resourcesArray2 !== null && resourcesArray2 !== undefined) {
                for (var loweredIndex7 = 0; loweredIndex7 < resourcesArray2.length; loweredIndex7 = loweredIndex7 + 1) {
                  var resourcesValue = resourcesArray2[loweredIndex7];
              ...
              if (diagnosticsArray2 !== null && diagnosticsArray2 !== undefined) {
                for (var loweredIndex8 = 0; loweredIndex8 < diagnosticsArray2.length; loweredIndex8 = loweredIndex8 + 1) {
                  var diagnosticsValue2 = diagnosticsArray2[loweredIndex8];
                  ...
                  var lineNumberValue = diagnosticsValue2['lineNumber'];
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (stateAuditRecordsArray !== null && stateAuditRecordsArray !== undefined) {
            for (var loweredIndex1 = 0; loweredIndex1 < stateAuditRecordsArray.length; loweredIndex1 = loweredIndex1 + 1) {
              var stateAuditRecordsValue = stateAuditRecordsArray[loweredIndex1];
              var jobStateAuditRecordInstance = {};
              jobInstance.stateAuditRecords.push(jobStateAuditRecordInstance);
          ...
          if (propertiesValue !== null && propertiesValue !== undefined) {
            ...
            if (typeName === 'Hive') {
              ...
              if (statementInfoArray !== null && statementInfoArray !== undefined) {
                for (var loweredIndex2 = 0; loweredIndex2 < statementInfoArray.length; loweredIndex2 = loweredIndex2 + 1) {
                  var statementInfoValue = statementInfoArray[loweredIndex2];
                  var hiveJobStatementInfoInstance = {};
                  hivePropertiesInstance.statementInfo.push(hiveJobStatementInfoInstance);
            ...
            if (typeName === 'USql') {
              ...
              if (resourcesArray !== null && resourcesArray !== undefined) {
                for (var loweredIndex3 = 0; loweredIndex3 < resourcesArray.length; loweredIndex3 = loweredIndex3 + 1) {
                  var resourcesValue = resourcesArray[loweredIndex3];
                  var jobResourceInstance = {};
                  uSqlPropertiesInstance.resources.push(jobResourceInstance);
              ...
              if (diagnosticsArray !== null && diagnosticsArray !== undefined) {
                for (var loweredIndex4 = 0; loweredIndex4 < diagnosticsArray.length; loweredIndex4 = loweredIndex4 + 1) {
                  var diagnosticsValue = diagnosticsArray[loweredIndex4];
                  var diagnosticsInstance = {};
                  uSqlPropertiesInstance.diagnostics.push(diagnosticsInstance);
                  ...
                  var lineNumberValue = diagnosticsValue['lineNumber'];
                  if (lineNumberValue !== null && lineNumberValue !== undefined) {
                    var lineNumberInstance = lineNumberValue;
                    diagnosticsInstance.lineNumber = lineNumberInstance;
                  }
                  
                  var messageValue = diagnosticsValue['message'];
                  if (messageValue !== null && messageValue !== undefined) {
                    var messageInstance = messageValue;
                    diagnosticsInstance.message = messageInstance;
                  }
                  
                  var severityValue = diagnosticsValue['severity'];
                  if (severityValue !== null && severityValue !== undefined) {
                    var severityInstance = severityValue;
                    diagnosticsInstance.severity = severityInstance;
                  }
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (valueArray !== null && valueArray !== undefined) {
            for (var loweredIndex1 = 0; loweredIndex1 < valueArray.length; loweredIndex1 = loweredIndex1 + 1) {
              ...
              var jobInformationInstance = { stateAuditRecords: [] };
              ...
              var errorMessageValue = valueValue['errorMessage'];
              if (errorMessageValue !== null && errorMessageValue !== undefined) {
                var errorMessageInstance = errorMessageValue;
