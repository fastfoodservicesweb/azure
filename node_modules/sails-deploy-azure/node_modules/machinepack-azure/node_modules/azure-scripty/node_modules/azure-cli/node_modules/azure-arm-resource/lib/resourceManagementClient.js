...
var DeploymentOperations = ( /** @lends DeploymentOperations */ function() {
   ...
   * @returns {Stream} The response stream.
   */
  DeploymentOperations.prototype.deleteMethod = function(resourceGroupName, deploymentName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    var client2 = this.client;
    
    return client2.deployments.beginDeleting(resourceGroupName, deploymentName, function (err, result) {
      if (err !== null && err !== undefined) {
        return callback(err);
      }
  ...
  DeploymentOperations.prototype.validate = function(resourceGroupName, deploymentName, parameters, callback) {
    ...
    url2 = url2 + '/resourcegroups/';
    url2 = url2 + encodeURIComponent(resourceGroupName);
    url2 = url2 + '/providers/microsoft.resources/deployments/';
    url2 = url2 + encodeURIComponent(deploymentName);
    url2 = url2 + '/validate';
    var queryParameters = [];
    queryParameters.push('api-version=2014-04-01-preview');
...
var ProviderOperationsMetadataOperations = ( /** @lends ProviderOperationsMetadataOperations */ function() {
  /**
   * @class
   ...
   * instance of the [ResourceManagementClient] {@link
   * ResourceManagementClient~ResourceManagementClient}.
   * See [providerOperationsMetadata] {@link
   * ResourceManagementClient~ResourceManagementClient#providerOperationsMetadata}.
   * Initializes a new instance of the ProviderOperationsMetadataOperations
   * class.
   * @constructor
   * 
   * @param {ResourceManagementClient} client Reference to the service client.
   ...
   * @returns {Stream} The response stream.
   */
  ProviderOperationsMetadataOperations.prototype.get = function(resourceProviderNamespace, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    // Construct URL
    var url2 = '';
    url2 = url2 + '/providers/Microsoft.Authorization/providerOperations/';
    url2 = url2 + encodeURIComponent(resourceProviderNamespace);
    var queryParameters = [];
    queryParameters.push('api-version=2015-07-01');
    queryParameters.push('$expand=resourceTypes');
    if (queryParameters.length > 0) {
      url2 = url2 + '?' + queryParameters.join('&');
    }
    var baseUrl = this.client.baseUri;
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          var providerInstance = { operations: [], resourceTypes: [] };
          result.provider = providerInstance;
          ...
          if (resourceTypesArray !== null && resourceTypesArray !== undefined) {
            for (var loweredIndex1 = 0; loweredIndex1 < resourceTypesArray.length; loweredIndex1 = loweredIndex1 + 1) {
              var resourceTypesValue = resourceTypesArray[loweredIndex1];
              var resourceTypeInstance = { operations: [] };
              providerInstance.resourceTypes.push(resourceTypeInstance);
              
              var nameValue2 = resourceTypesValue['name'];
              if (nameValue2 !== null && nameValue2 !== undefined) {
                var nameInstance2 = nameValue2;
                resourceTypeInstance.name = nameInstance2;
              }
              
              var displayNameValue2 = resourceTypesValue['displayName'];
              ...
              var operationsArray = resourceTypesValue['operations'];
              if (operationsArray !== null && operationsArray !== undefined) {
                for (var loweredIndex2 = 0; loweredIndex2 < operationsArray.length; loweredIndex2 = loweredIndex2 + 1) {
                  var operationsValue = operationsArray[loweredIndex2];
                  var operationInstance = {};
                  resourceTypeInstance.operations.push(operationInstance);
                  
                  var nameValue3 = operationsValue['name'];
                  if (nameValue3 !== null && nameValue3 !== undefined) {
                    var nameInstance3 = nameValue3;
                    operationInstance.name = nameInstance3;
                  }
                  
                  var displayNameValue3 = operationsValue['displayName'];
                  ...
                  var descriptionValue = operationsValue['description'];
                  ...
                  var originValue = operationsValue['origin'];
                  if (originValue !== null && originValue !== undefined) {
                    var originInstance = originValue;
                    operationInstance.origin = originInstance;
                  }
                  
                  var propertiesValue = operationsValue['properties'];
                  if (propertiesValue !== null && propertiesValue !== undefined) {
          ...
          var operationsArray2 = responseDoc['operations'];
          if (operationsArray2 !== null && operationsArray2 !== undefined) {
            for (var loweredIndex3 = 0; loweredIndex3 < operationsArray2.length; loweredIndex3 = loweredIndex3 + 1) {
              var operationsValue2 = operationsArray2[loweredIndex3];
              var operationInstance2 = {};
              providerInstance.operations.push(operationInstance2);
              
              var nameValue4 = operationsValue2['name'];
              if (nameValue4 !== null && nameValue4 !== undefined) {
                var nameInstance4 = nameValue4;
                operationInstance2.name = nameInstance4;
              }
              
              var displayNameValue4 = operationsValue2['displayName'];
              ...
              var descriptionValue2 = operationsValue2['description'];
              ...
              var originValue2 = operationsValue2['origin'];
              if (originValue2 !== null && originValue2 !== undefined) {
                var originInstance2 = originValue2;
                operationInstance2.origin = originInstance2;
              }
              
              var propertiesValue2 = operationsValue2['properties'];
              if (propertiesValue2 !== null && propertiesValue2 !== undefined) {
                var propertiesInstance2 = propertiesValue2;
   ...
   * @returns {Stream} The response stream.
   */
  ProviderOperationsMetadataOperations.prototype.list = function(callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (valueArray !== null && valueArray !== undefined) {
            for (var loweredIndex1 = 0; loweredIndex1 < valueArray.length; loweredIndex1 = loweredIndex1 + 1) {
              var valueValue = valueArray[loweredIndex1];
              var providerOperationsMetadataInstance = { operations: [], resourceTypes: [] };
              result.providers.push(providerOperationsMetadataInstance);
              ...
              if (resourceTypesArray !== null && resourceTypesArray !== undefined) {
                for (var loweredIndex2 = 0; loweredIndex2 < resourceTypesArray.length; loweredIndex2 = loweredIndex2 + 1) {
                  var resourceTypesValue = resourceTypesArray[loweredIndex2];
                  var resourceTypeInstance = { operations: [] };
                  providerOperationsMetadataInstance.resourceTypes.push(resourceTypeInstance);
                  ...
                  var operationsArray = resourceTypesValue['operations'];
                  if (operationsArray !== null && operationsArray !== undefined) {
                    for (var loweredIndex3 = 0; loweredIndex3 < operationsArray.length; loweredIndex3 = loweredIndex3 + 1) {
                      var operationsValue = operationsArray[loweredIndex3];
                      var operationInstance = {};
                      resourceTypeInstance.operations.push(operationInstance);
              ...
              var operationsArray2 = valueValue['operations'];
              if (operationsArray2 !== null && operationsArray2 !== undefined) {
                for (var loweredIndex4 = 0; loweredIndex4 < operationsArray2.length; loweredIndex4 = loweredIndex4 + 1) {
                  var operationsValue2 = operationsArray2[loweredIndex4];
                  var operationInstance2 = {};
                  providerOperationsMetadataInstance.operations.push(operationInstance2);
...
var ResourceOperations = ( /** @lends ResourceOperations */ function() {
   ...
   * @returns {Stream} The response stream.
   */
  ResourceOperations.prototype.beginMoving = function(sourceResourceGroupName, parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    if (sourceResourceGroupName !== null && sourceResourceGroupName !== undefined && sourceResourceGroupName.length > 1000) {
      return callback(new Error('sourceResourceGroupName is outside the valid range.'));
    }
    if (/^[-\w\._]+$/.test(sourceResourceGroupName) === false) {
      return callback(new Error('sourceResourceGroupName is outside the valid range.'));
    }
    if (parameters === null || parameters === undefined) {
      return callback(new Error('parameters cannot be null.'));
  ...
  ResourceOperations.prototype.moveResources = function(sourceResourceGroupName, parameters, callback) {
    ...
    return client2.resources.beginMoving(sourceResourceGroupName, parameters, function (err, result) {
      if (err !== null && err !== undefined) {
        return callback(err);
      }
      var delayInSeconds = result.retryAfter;
