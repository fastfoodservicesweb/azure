...
exports.init = function(cli) {
  ...
  appGateway.command("create [name] [vnet-name] [subnet-names]").description($("Create an Application Gateway")).usage("[options] <name> <vnet-name> <subnet-names>").option("-n, --name <name>", $("the name of the Application Gateway")).option("-e, --vnet-name <vnet-name>", $("the name of the virtual network Application Gateway should be deployed in")).option("-t, --subnet-names <subnet-names>", $("comma separated list of subnet names exists in the virtual network identified by --vnet-name")).option("-c, --instance-count <instance-count>", $("the number of instances")).option("-z, --gateway-size <gateway-size>", util.format($("size of the Application Gateway, valid values are [%s]"), constants.appGateway.sizes)).option("-d, --description <description>", $("the description for the Application Gateway")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __62(name, vnetName, subnetNames, options, _) { var networkManagementClient, appGateway; var __frame = { name: "__62", line: 1008 }; return __func(_, this, arguments, __62, 4, __frame, function __$__62() {
      ...
      return cli.interaction.promptIfNotGiven($("Application Gateway name: "), name, __cb(_, __frame, 1, 29, function ___(__0, __1) { name = __1;
        return cli.interaction.promptIfNotGiven($("Virtual network name: "), vnetName, __cb(_, __frame, 2, 33, function ___(__0, __2) { vnetName = __2;
          return cli.interaction.promptIfNotGiven($("Comma separated subnet names: "), subnetNames, __cb(_, __frame, 3, 36, function ___(__0, __3) { subnetNames = __3;

            networkManagementClient = createNetworkManagementClient(options);
            appGateway = new AppGateway(cli, networkManagementClient);
            return appGateway.create(name, vnetName, subnetNames, options, __cb(_, __frame, 7, 17, function __$__62() { _(); }, true)); }, true)); }, true)); }, true)); }); });


  appGateway.command("set [name] [vnet-name]").description($("Set an Application Gateway")).usage("[options] <name> <vnet-name>").option("-n, --name <name>", $("the name of the Application Gateway")).option("-e, --vnet-name <vnet-name>", $("the name of the virtual network Application Gateway should be deployed in")).option("-t, --subnet-names <subnet-names>", $("comma separated list of subnet names exists in the virtual network identified by --vnet-name")).option("-c, --instance-count <instance-count>", $("the number of instances")).option("-z, --gateway-size <gateway-size>", util.format($("size of the Application Gateway, valid values are [%s]"), constants.appGateway.sizes)).option("-d, --description <description>", $("the description for the Application Gateway")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __63(name, vnetName, options, _) { var networkManagementClient, appGateway; var __frame = { name: "__63", line: 1028 }; return __func(_, this, arguments, __63, 3, __frame, function __$__63() {
      ...
      return cli.interaction.promptIfNotGiven($("Application Gateway name: "), name, __cb(_, __frame, 1, 29, function ___(__0, __1) { name = __1;
        return cli.interaction.promptIfNotGiven($("Virtual network name: "), vnetName, __cb(_, __frame, 2, 33, function ___(__0, __2) { vnetName = __2;
          ...
          networkManagementClient = createNetworkManagementClient(options);
          appGateway = new AppGateway(cli, networkManagementClient);
          return appGateway.set(name, vnetName, options, __cb(_, __frame, 6, 17, function __$__63() { _(); }, true)); }, true)); }, true)); }); });


  appGateway.command("list").description($("Get all Application Gateways")).usage("[options]").option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __64(options, _) { var networkManagementClient, appGateway; var __frame = { name: "__64", line: 1041 }; return __func(_, this, arguments, __64, 1, __frame, function __$__64() {
  ...
  appGateway.command("stop [name]").description($("Stop an Application Gateway")).usage("[options] <name>").option("-n, --name <name>", $("the name of the Application Gateway")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __68(name, options, _) { var networkManagementClient, appGateway; var __frame = { name: "__68", line: 1092 }; return __func(_, this, arguments, __68, 2, __frame, function __$__68() {
  ...
  appGatewayConfig.command("export [name] [export-to-file]").description($("Export Application Gateway configuration to a file")).usage("[options] <name> <file-path>").option("-n, --name <name>", $("the name of the Application Gateway")).option("-t, --export-to-file <export-to-file>", $("the path to the file where configuration needs to be exported")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __70(name, exportToFile, options, _) { var networkManagementClient, appGateway; var __frame = { name: "__70", line: 1122 }; return __func(_, this, arguments, __70, 3, __frame, function __$__70() {
  ...
  appGatewayConfig.command("import [name] [import-from-file]").description($("Import Application Gateway configuration from a file")).usage("[options] <name> <import-from-file>").option("-n, --name <name>", $("the name of the Application Gateway")).option("-t, --import-from-file <import-from-file>", $("the path to the configuration file")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __71(name, importFromFile, options, _) { var networkManagementClient, appGateway; var __frame = { name: "__71", line: 1137 }; return __func(_, this, arguments, __71, 3, __frame, function __$__71() {
  ...
  appGatewayFrontendIp.command("add [gateway-name] [name]").description($("Add a frontend ip configuration to an Application Gateway")).usage("[options] <gateway-name> <name>").option("-w, --gateway-name <gateway-name>", $("the name of the Application Gateway")).option("-n, --name <name>", $("the name of the frontend IP configuration")).option("-t, --type <type>", util.format($("the type, supported values are [%s], default value is Private"), constants.appGateway.ip.type)).option("-i, --static-ip-address <static-ip-address>", $("the static IP address")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __76(gatewayName, name, options, _) { var networkManagementClient, appGateway; var __frame = { name: "__76", line: 1237 }; return __func(_, this, arguments, __76, 3, __frame, function __$__76() {
  ...
  appGatewayFrontendPort.command("add [gateway-name] [name] [port]").description($("Add a frontend port to an Application Gateway")).usage("[options] <gateway-name> <name> <port>").option("-w, --gateway-name <gateway-name>", $("the name of the Application Gateway")).option("-n, --name <name>", $("the name of the frontend port")).option("-o, --port <port>", $("the port")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __78(gatewayName, name, port, options, _) { var networkManagementClient, appGateway; var __frame = { name: "__78", line: 1273 }; return __func(_, this, arguments, __78, 4, __frame, function __$__78() {
  ...
  appGatewaySslCert.command("add [name] [cert-name]").description($("Add Application Gateway SSL certificate")).usage("[options] <name> <cert-name>").option("-n, --name <name>", $("the name of the Application Gateway")).option("-c, --cert-name <cert-name>", $("the name of the certificate")).option("-t, --cert-file <cert-file>", $("the path to the certificate")).option("-p, --password <password>", $("the certificate password")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __84(name, certName, options, _) { var networkManagementClient, appGateway; var __frame = { name: "__84", line: 1390 }; return __func(_, this, arguments, __84, 3, __frame, function __$__84() {
  ...
  tmProfile.command("create [name]").usage("[options] <name>").description($("Create a Traffic Manager profile")).option("-n, --name <name>", $("the name of the Traffic Manager profile")).option("-d, --domain-name <domain-name>", $(("profile DNS name" + "\n   Example: foobar.trafficmanager.net"))).option("-m, --load-balancing-method <load-balancing-method>", util.format($(("the load balancing method to use to distribute connection." + "\n   Valid values are [%s]")), constants.trafficManager.loadBalancingMethods)).option("-o, --monitor-port <monitor-port>", util.format($(("the port used to monitor endpoint health." + "\n   Valid range is %s inclusive")), utils.toRange(constants.trafficManager.ports))).option("-p, --monitor-protocol <monitor-protocol>", util.format($(("the protocol to use to monitor endpoint health." + "\n   Valid values are [%s]")), constants.trafficManager.protocols)).option("-r, --monitor-relative-path <monitor-relative-path>", $("the path relative to the endpoint domain name to probe for health state. Must start with a forward slash \"/\".")).option("-t, --ttl <ttl>", $("the DNS Time-to-Live (TTL) that informs the Local DNS resolvers how long to cache DNS entries")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __86(name, options, _) { var trafficManagerManagementClient, trafficManager; var __frame = { name: "__86", line: 1437 }; return __func(_, this, arguments, __86, 2, __frame, function __$__86() {
      ...
      return cli.interaction.promptIfNotGiven($("Traffic Manager name: "), name, __cb(_, __frame, 1, 29, function ___(__0, __1) { name = __1;
        return cli.interaction.promptIfNotGiven($("Endpoint domain name: "), options.domainName, __cb(_, __frame, 2, 43, function ___(__0, __2) { options.domainName = __2;
          return cli.interaction.promptIfNotGiven($("Path relative to the endpoint domain name to probe for health state: "), options.monitorRelativePath, __cb(_, __frame, 3, 52, function ___(__0, __3) { options.monitorRelativePath = __3;
            ...
            return trafficManager.create(name, options, __cb(_, __frame, 7, 21, function __$__86() { _(); }, true)); }, true)); }, true)); }, true)); }); });


  tmProfile.command("set [name]").usage("[options] <name>").description($("Set a Traffic Manager profile")).option("-n, --name <name>", $("the name of the Traffic Manager profile")).option("-m, --load-balancing-method <load-balancing-method>", util.format($(("the load balancing method to use to distribute connection." + "\n   Valid values are [%s]")), constants.trafficManager.loadBalancingMethods)).option("-o, --monitor-port <monitor-port>", util.format($(("the port used to monitor endpoint health." + "\n   Valid range is %s inclusive")), utils.toRange(constants.trafficManager.ports))).option("-p, --monitor-protocol <monitor-protocol>", util.format($(("the protocol to use to monitor endpoint health." + "\n   Valid values are [%s]")), constants.trafficManager.protocols)).option("-r, --monitor-relative-path <monitor-relative-path>", $("the path relative to the endpoint domain name to probe for health state. Must start with a forward slash \"/\".")).option("-t, --ttl <ttl>", $("the DNS Time-to-Live (TTL) that informs the Local DNS resolvers how long to cache DNS entries")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __87(name, options, _) { var trafficManagerManagementClient, trafficManager; var __frame = { name: "__87", line: 1460 }; return __func(_, this, arguments, __87, 2, __frame, function __$__87() {
      ...
      return cli.interaction.promptIfNotGiven($("Traffic Manager name: "), name, __cb(_, __frame, 1, 29, function ___(__0, __1) { name = __1;
        ...
        trafficManagerManagementClient = createTrafficManagerManagementClient(options);
        trafficManager = new TrafficManager(cli, trafficManagerManagementClient);
        return trafficManager.set(name, options, __cb(_, __frame, 5, 21, function __$__87() { _(); }, true)); }, true)); }); });


  tmProfile.command("show [name]").usage("[options] <name>").description($("Get a Traffic Manager profile")).option("-n, --name <name>", $("the name of the Traffic Manager profile")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __88(name, options, _) { var trafficManagerManagementClient, trafficManager; var __frame = { name: "__88", line: 1473 }; return __func(_, this, arguments, __88, 2, __frame, function __$__88() {
      ...
      return cli.interaction.promptIfNotGiven($("Traffic Manager name: "), name, __cb(_, __frame, 1, 29, function ___(__0, __1) { name = __1;
        ...
        trafficManagerManagementClient = createTrafficManagerManagementClient(options);
        trafficManager = new TrafficManager(cli, trafficManagerManagementClient);
        return trafficManager.show(name, options, __cb(_, __frame, 5, 21, function __$__88() { _(); }, true)); }, true)); }); });


  tmProfile.command("list").usage("[options]").description($("Get all Traffic Manager profiles")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __89(options, _) { var trafficManagerManagementClient, trafficManager; var __frame = { name: "__89", line: 1485 }; return __func(_, this, arguments, __89, 1, __frame, function __$__89() {
      ...
      trafficManagerManagementClient = createTrafficManagerManagementClient(options);
      trafficManager = new TrafficManager(cli, trafficManagerManagementClient);
      return trafficManager.list(options, __cb(_, __frame, 3, 21, function __$__89() { _(); }, true)); }); });


  tmProfile.command("delete [name]").description($("Delete a Traffic Manager profile")).usage("[options] <name>").option("-n, --name <name>", $("the name of the Traffic Manager")).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __90(name, options, _) { var trafficManagerManagementClient, trafficManager; var __frame = { name: "__90", line: 1497 }; return __func(_, this, arguments, __90, 2, __frame, function __$__90() {
      ...
      return cli.interaction.promptIfNotGiven($("Traffic Manager profile name: "), name, __cb(_, __frame, 1, 29, function ___(__0, __1) { name = __1;
        ...
        trafficManagerManagementClient = createTrafficManagerManagementClient(options);
        trafficManager = new TrafficManager(cli, trafficManagerManagementClient);
        return trafficManager.delete(name, options, __cb(_, __frame, 5, 21, function __$__90() { _(); }, true)); }, true)); }); });


  tmProfile.command("enable [name]").description($("Enable a Traffic Manager profile")).usage("[options] <name>").option("-n, --name <name>", $("the name of the Traffic Manager")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __91(name, options, _) { var trafficManagerManagementClient, trafficManager; var __frame = { name: "__91", line: 1510 }; return __func(_, this, arguments, __91, 2, __frame, function __$__91() {
      ...
      return cli.interaction.promptIfNotGiven($("Traffic Manager profile name: "), name, __cb(_, __frame, 1, 29, function ___(__0, __1) { name = __1;
        ...
        trafficManagerManagementClient = createTrafficManagerManagementClient(options);
        trafficManager = new TrafficManager(cli, trafficManagerManagementClient);
        return trafficManager.enable(name, options, __cb(_, __frame, 5, 21, function __$__91() { _(); }, true)); }, true)); }); });


  tmProfile.command("disable [name]").description($("Disable a Traffic Manager profile")).usage("[options] <name>").option("-n, --name <name>", $("the name of the Traffic Manager")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __92(name, options, _) { var trafficManagerManagementClient, trafficManager; var __frame = { name: "__92", line: 1523 }; return __func(_, this, arguments, __92, 2, __frame, function __$__92() {
      ...
      return cli.interaction.promptIfNotGiven($("Traffic Manager profile name: "), name, __cb(_, __frame, 1, 29, function ___(__0, __1) { name = __1;
        ...
        trafficManagerManagementClient = createTrafficManagerManagementClient(options);
        trafficManager = new TrafficManager(cli, trafficManagerManagementClient);
        return trafficManager.disable(name, options, __cb(_, __frame, 5, 21, function __$__92() { _(); }, true)); }, true)); }); });


  var profileEndpoint = tmProfile.category("endpoint").description($("Commands to manage Traffic Manager profile endpoint"));


  profileEndpoint.command("create [profile-name] [name] [type]").description($("Create an endpoint in a Traffic Manager profile")).usage("[options] <profile-name> <name> <type>").option("-p, --profile-name <profile-name>", $("the name of the profile")).option("-n, --name <name>", $("the endpoint domain name")).option("-y, --type <type>", util.format($("the endpoint type, valid values are: %s"), constants.trafficManager.endpoints.types)).option("-l, --endpoint-location <endpoint-location>", $((("the location of the endpoint. Required when profile load-balancing" + "\n     method is set to Performance and endpoint type is set to ") + "\n     Any or TrafficManager. Specifies the name of the Azure region"))).option("-u, --endpoint-status <endpoint-status>", util.format($("the endpoint status, valid values are: %s Default is Enabled"), constants.trafficManager.endpoints.statuses)).option("-w, --weight <weight>", $("the endpoint weight used in the load balancing algorithm")).option("-e, --min-child-endpoint <min-child-endpoint>", $("the minimum number of child endpoints, can be specified when Type is set to TrafficManager")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __93(profileName, name, type, options, _) { var trafficManagerManagementClient, trafficManager; var __frame = { name: "__93", line: 1549 }; return __func(_, this, arguments, __93, 4, __frame, function __$__93() {
  ...
  profileEndpoint.command("delete [profile-name] [name]").description($("Delete an endpoint from a Traffic Manager profile")).usage("[options] <profile-name> <name>").option("-p, --profile-name <profile-name>", $("the name of the profile")).option("-n, --name <name>", $("the endpoint domain name")).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __95(profileName, name, options, _) { var trafficManagerManagementClient, trafficManager; var __frame = { name: "__95", line: 1590 }; return __func(_, this, arguments, __95, 3, __frame, function __$__95() {
