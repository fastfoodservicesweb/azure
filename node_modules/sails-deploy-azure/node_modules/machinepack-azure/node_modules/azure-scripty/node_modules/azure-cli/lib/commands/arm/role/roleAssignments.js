...
underscore.extend(RoleAssignments.prototype, {
  ...
  queryAssignmentsForList: function queryAssignmentsForList__1(principal, scope, roleName, roleId, shouldExpandPrincipalGroups, shouldIncludeClassicAdmins, cli, subscription, _) { var assignments, objectType, shouldRetrieveObjectType, principalId, parameters, roleDefinitions, excludeAssignmentsForDeletedPrincipals, admins, adminsAsAssignments, objects, __this = this; var __frame = { name: "queryAssignmentsForList__1", line: 36 }; return __func(_, this, arguments, queryAssignmentsForList__1, 8, __frame, function __$queryAssignmentsForList__1() {
      ...
      return adUtils.getObjectId(principal, __this.graphClient, false, shouldRetrieveObjectType, objectType, __cb(_, __frame, 4, 30, function ___(__0, __1) { principalId = __1;
        parameters = { atScope: false }; return (function __$queryAssignmentsForList__1(__then) {
          ...
          return __this.getRoleDefinitions(__cb(_, __frame, 30, 31, function ___(__0, __5) { roleDefinitions = __5;
            ...
            return __this.filterForDeletedPrincipalsAndFillInPrincipalInfo(assignments, excludeAssignmentsForDeletedPrincipals, __cb(_, __frame, 37, 23, function ___(__0, __6) { assignments = __6;
              ...
              if (roleId) {
                ...
                if (shouldIncludeClassicAdmins) {
                  return __this.authzClient.classicAdministrators.list(__cb(_, __frame, 48, 58, function ___(__0, __7) { admins = __7;
                    adminsAsAssignments = __this.convertAdminsToAssignments(admins, subscription); return (function __$queryAssignmentsForList__1(__then) {
                      ...
                      if ((__this.optionIsSet(principal) && principalId)) {
                        ...
                        return __this.graphClient.objects.getObjectsByObjectIds({ ids: new Array(principalId), includeDirectoryObjectReferences: true }, __cb(_, __frame, 57, 47, function ___(__0, __8) { objects = __8.aADObject;
        ...
        parameters = { atScope: false }; return (function __$queryAssignmentsForDelete__2(__then) {
          ...
          roleDefinitions = []; return (function __$queryAssignmentsForDelete__2(__then) {
            ...
            if (roleName) {
              ...
              return __this.authzClient.roleDefinitions.listWithFilters(filterParameters, __cb(_, __frame, 20, 57, function ___(__0, __3) { roleDefinitions = __3.roleDefinitions; __then(); }, true)); } else {



              return __this.authzClient.roleDefinitions.get(roleId, __cb(_, __frame, 24, 60, function ___(__0, __4) { roleDefinition = __4.roleDefinition;
  ...
  getAssignmentsList: function getAssignmentsList__3(parameter, _) { var assignmentsToReturn, tempResult, nextLink, __this = this; var __frame = { name: "getAssignmentsList__3", line: 147 }; return __func(_, this, arguments, getAssignmentsList__3, 1, __frame, function __$getAssignmentsList__3() {
      assignmentsToReturn = [];
  ...
  getRoleDefinitions: function getRoleDefinitions__6(_) { var __this = this; var __frame = { name: "getRoleDefinitions__6", line: 301 }; return __func(_, this, arguments, getRoleDefinitions__6, 0, __frame, function __$getRoleDefinitions__6() {
      return __this.authzClient.roleDefinitions.list(__cb(_, __frame, 1, 44, function ___(__0, __2) { var __1 = __2.roleDefinitions; return _(null, __1); }, true)); }); },


  fillRoleAndPrincipalDetailsForAssignment: function fillRoleAndPrincipalDetailsForAssignment__7(assignment, roleDefinition, _) { var assignments, __this = this; var __frame = { name: "fillRoleAndPrincipalDetailsForAssignment__7", line: 305 }; return __func(_, this, arguments, fillRoleAndPrincipalDetailsForAssignment__7, 2, __frame, function __$fillRoleAndPrincipalDetailsForAssignment__7() {
