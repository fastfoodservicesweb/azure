...
var DataLakeStoreAccountOperations = ( /** @lends DataLakeStoreAccountOperations */ function() {
  ...
  DataLakeStoreAccountOperations.prototype.beginCreate = function(resourceGroupName, parameters, callback) {
    ...
    if ('Azure SDK - Microsoft.Azure.Management.DataLake.Store 0.9.1-preview' + this.client.userAgentSuffix !== null && 'Azure SDK - Microsoft.Azure.Management.DataLake.Store 0.9.1-preview' + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['useragent'] = 'Azure SDK - Microsoft.Azure.Management.DataLake.Store 0.9.1-preview' + this.client.userAgentSuffix;
    }
    if ('Azure SDK - Microsoft.Azure.Management.DataLake.Store 0.9.1-preview' + this.client.userAgentSuffix !== null && 'Azure SDK - Microsoft.Azure.Management.DataLake.Store 0.9.1-preview' + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['User-Agent'] = 'Azure SDK - Microsoft.Azure.Management.DataLake.Store 0.9.1-preview' + this.client.userAgentSuffix;
    }
