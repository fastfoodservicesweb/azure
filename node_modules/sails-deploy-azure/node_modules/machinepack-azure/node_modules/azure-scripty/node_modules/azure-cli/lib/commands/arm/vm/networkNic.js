...
__.extend(NetworkNic.prototype, {
        ...
        if (hasNicIdParam) {
          ...
          if (nicInfo.profile) {
            ...
            return __this._createNewNIC(nicInfo.resourceGroupName, __this.params, __cb(_, __frame, 50, 30, function ___(__0, __6) { createInfo = __6;
              ...
              return __this.getNICInfoByName(nicInfo.resourceGroupName, nicInfo.nicName, __cb(_, __frame, 52, 23, function ___(__0, __7) { nicInfo = __7;
  ...
  getNICInfoById: function getNICInfoById__2(referenceUri, _) { var resourceInfo, __this = this; var __frame = { name: "getNICInfoById__2", line: 97 }; return __func(_, this, arguments, getNICInfoById__2, 1, __frame, function __$getNICInfoById__2() {
  ...
  getNICInfoByName: function getNICInfoByName__3(resourceGroupName, nicName, _) { var nicInfo, nic, __this = this; var __frame = { name: "getNICInfoByName__3", line: 106 }; return __func(_, this, arguments, getNICInfoByName__3, 2, __frame, function __$getNICInfoByName__3() {
      nicInfo = {
        nicName: nicName,
  ...
  getNICByIdExpanded: function getNICByIdExpanded__4(referenceUri, depth, memoize, dependencies, _) { var resourceInfo, expandedNIC, __this = this; var __frame = { name: "getNICByIdExpanded__4", line: 126 }; return __func(_, this, arguments, getNICByIdExpanded__4, 4, __frame, function __$getNICByIdExpanded__4() {
  ...
  getNICByNameExpanded: function getNICByNameExpanded__5(resourceGroupName, nicName, depth, memoize, dependencies, _) { var nic, expandedNIC, __this = this; var __frame = { name: "getNICByNameExpanded__5", line: 137 }; return __func(_, this, arguments, getNICByNameExpanded__5, 5, __frame, function __$getNICByNameExpanded__5() {
  ...
  _getNIC: function _getNIC__6(resourceGroupName, nicName, _) { var progress, nic, __this = this; var __frame = { name: "_getNIC__6", line: 143 }; return __func(_, this, arguments, _getNIC__6, 2, __frame, function __$_getNIC__6() {
  ...
  _updateNICIfRequired: function _updateNICIfRequired__7(resourceGroupName, networkInterface, params, allowNewIpConfig, _) { var nicUpdateInfo, existingIpConfiguration, nic, ipConfigInfo, networkVNet, subnetId, networkPublicIP, publicipId, partialPublicIdFromParams, __this = this; var __frame = { name: "_updateNICIfRequired__7", line: 158 }; return __func(_, this, arguments, _updateNICIfRequired__7, 4, __frame, function __$_updateNICIfRequired__7() {
      nicUpdateInfo = {
        updated: false,
        vnetInfo: null,
        publicipInfo: null };
  ...
  _createNewIPConfigurationTrySetSubnetPublicIP: function _createNewIPConfigurationTrySetSubnetPublicIP__8(nicName, _) { var vnetInfo, ipConfigInfo, __this = this; var __frame = { name: "_createNewIPConfigurationTrySetSubnetPublicIP__8", line: 243 }; return __func(_, this, arguments, _createNewIPConfigurationTrySetSubnetPublicIP__8, 1, __frame, function __$_createNewIPConfigurationTrySetSubnetPublicIP__8() {
  ...
  _createNewIPConfigurationTrySetPublicIP: function _createNewIPConfigurationTrySetPublicIP__9(subnetId, nicName, _) { var newipConfiguration, ipConfigInfo, publicipInfo, ipConfigResourceInfo, connectedNicName, __this = this; var __frame = { name: "_createNewIPConfigurationTrySetPublicIP__9", line: 250 }; return __func(_, this, arguments, _createNewIPConfigurationTrySetPublicIP__9, 2, __frame, function __$_createNewIPConfigurationTrySetPublicIP__9() {
      newipConfiguration = {
        subnet: {
          id: subnetId },
  ...
  _preparePublicIP: function _preparePublicIP__10(_) { var publicipInfo, networkPublicIP, anyPublicIpParams, __this = this; var __frame = { name: "_preparePublicIP__10", line: 286 }; return __func(_, this, arguments, _preparePublicIP__10, 0, __frame, function __$_preparePublicIP__10() {
      publicipInfo = null;
      networkPublicIP = new NetworkPublicIP(__this.cli, __this.networkResourceProviderClient, __this.resourceGroupName, __this.params);
  ...
  _prepareSubnet: function _prepareSubnet__11(_) { var vnetInfo, networkVNetSubnet, subnetInfo, networkVNet, __this = this; var __frame = { name: "_prepareSubnet__11", line: 306 }; return __func(_, this, arguments, _prepareSubnet__11, 0, __frame, function __$_prepareSubnet__11() {
  ...
  _updateNIC: function _updateNIC__12(resourceGroupName, nic, _) { var progress, __this = this; var __frame = { name: "_updateNIC__12", line: 345 }; return __func(_, this, arguments, _updateNIC__12, 2, __frame, function __$_updateNIC__12() {
  ...
  _createNewNIC: function _createNewNIC__13(resourceGroupName, params, _) { var createRequestProfile, ipConfigInfo, progress, __this = this; var __frame = { name: "_createNewNIC__13", line: 354 }; return __func(_, this, arguments, _createNewNIC__13, 2, __frame, function __$_createNewNIC__13() {
      createRequestProfile = {
        ipConfigurations: [],
      ...
      return __this._createNewIPConfigurationTrySetSubnetPublicIP(params.nicName, __cb(_, __frame, 7, 30, function ___(__0, __1) { ipConfigInfo = __1;
        ...
        progress = __this.cli.interaction.progress(util.format($("Creating NIC \"%s\""), params.nicName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$_createNewNIC__13() {
              ...
              return __this.networkResourceProviderClient.networkInterfaces.createOrUpdate(__this.resourceGroupName, params.nicName, createRequestProfile, __cb(_, __frame, 15, 61, function __$_createNewNIC__13() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$_createNewNIC__13() {
  ...
  _expandNIC: function _expandNIC__14(nic, depth, memoize, dependencies, _) { var networkInterface, referenceUri, ipConfigurations, networkVNetSubnet, networkPublicIP, i, ipConfiguration, subnetReferenceId, publicIpReferenceId, __this = this; var __frame = { name: "_expandNIC__14", line: 381 }; return __func(_, this, arguments, _expandNIC__14, 4, __frame, function __$_expandNIC__14() {
      if (((depth === 0) || (nic === null))) {
        return _(null, nic); } ;
