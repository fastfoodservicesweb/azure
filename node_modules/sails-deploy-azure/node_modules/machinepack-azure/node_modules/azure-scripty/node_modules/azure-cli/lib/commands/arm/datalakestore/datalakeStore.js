...
exports.init = function(cli) {
  ...
  dataLakeStoreFileSystem.command("create [accountName] [path] [value] [folder] [force]").description($("Creates the specified folder or file, with the option to include content in file creation.")).usage("[options] <accountName> <path> <value>").option("-n --accountName <accountName>", $("the Data Lake Store account name to execute the action on")).option("-p --path <path>", $("the full path to the file to add content to (e.g. /someFolder/someFile.txt)")).option("-v --value <value>", $("optional indicates the contents (as a string) to create the file with. NOTE: This parameter cannot be specified with --folder (-d)")).option("-d --folder", $("optionally specify that the item being created is a folder, not a file. If this is not specified, a file will be created. NOTE: This parameter cannot be specified with --encoding (-e) or --value (-v)")).option("-f --force", $("optionally indicates that the file or folder being created can overwrite the file or folder at path if it already exists (default is false). 'true' must be passed in for the overwrite to work")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __4(accountName, path, value, folder, force, options, _) { var subscription, clientOptions, client, result, parameters; var __frame = { name: "__4", line: 130 }; return __func(_, this, arguments, __4, 6, __frame, function __$__4() {
      ...
      client = utils.createDataLakeStoreFileSystemManagementClient(subscription, clientOptions); return (function __$__4(__then) {
        ...
        if (folder) {
          ...
          return withProgress(util.format($("Creating file %s"), path), function __1(log, _) { var response; var __frame = { name: "__1", line: 168 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {

              return client.fileSystem.internalBeginCreate(path, accountName, parameters, __cb(_, __frame, 1, 43, function ___(__0, __1) { response = __1;
                if (!value) {
                  value = ""; } ;

                return client.fileSystem.create(response.location, value, __cb(_, __frame, 5, 28, function __$__1() { _(); }, true)); }, true)); }); }, __cb(_, __frame, 37, 8, __then, true)); } ; })(function __$__4() {
  ...
  dataLakeStoreFileSystem.command("import [accountName] [path] [destination] [force]").description($("Uploads the specified the specified file, to the target destination in an Azure Data Lake. NOTE: Only text files are supported by this command at present.")).usage("[options] <accountName> <path> <destination>").option("-n --accountName <accountName>", $("the Data Lake Store account name to execute the action on")).option("-p --path <path>", $("the full local path to the file to import (e.g. /someFolder/someFile.txt or C:somefoldersomeFile.txt)")).option("-d --destination <destination>", $("the full path in the Data Lake Store where the file should be imported to (e.g. /someFolder/someFile.txt")).option("-f --force", $("optionally indicates that the file or folder being created can overwrite the file or folder at path if it already exists (default is false). 'true' must be passed in for the overwrite to work")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __5(accountName, path, destination, force, options, _) { var subscription, clientOptions, client, parameters, fileStats; var __frame = { name: "__5", line: 188 }; return __func(_, this, arguments, __5, 5, __frame, function __$__5() {
      ...
      return fs.stat(path, __cb(_, __frame, 31, 25, function ___(__0, __2) { fileStats = __2;
        ...
        return withProgress(util.format($("Uploading file %s to the Data Lake Store location: %s"), path, destination), function __1(log, _) { var fileSizeInBytes, maxBytesToRead, response, fileHandle, offset, bytesToRead, buffer; var __frame = { name: "__1", line: 225 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {

            fileSizeInBytes = fileStats.size;
            maxBytesToRead = ((4 * 1024) * 1024);


            return fs.open(path, "r", __cb(_, __frame, 5, 28, function ___(__0, __1) { fileHandle = __1; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {

                    offset = 0; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$__1() { __more = false;
                        var __5 = (offset < fileSizeInBytes); if (__5) {
                          ...
                          return fs.read(fileHandle, buffer, 0, bytesToRead, offset, __cb(_, __frame, 15, 15, function __$__1() { return (function __$__1(__then) {

                              if ((offset === 0)) {
                                return client.fileSystem.internalBeginCreate(destination, accountName, parameters, __cb(_, __frame, 18, 43, function ___(__0, __2) { response = __2;
                                  return client.fileSystem.create(response.location, buffer, __cb(_, __frame, 19, 32, __then, true)); }, true)); } else {


                                return client.fileSystem.internalBeginAppend(destination, accountName, null, __cb(_, __frame, 22, 43, function ___(__0, __3) { response = __3;
                                  return client.fileSystem.append(response.location, buffer, __cb(_, __frame, 23, 32, __then, true)); }, true)); } ; })(function __$__1() {
  ...
  dataLakeStoreFileSystem.command("concat [accountName] [paths] [destination] [force]").description($("Concatenates the specified list of files into the specified destination file.")).usage("[options] <accountName> <paths> <destination> <force>").option("-n --accountName <accountName>", $("the Data Lake Store account name to execute the action on")).option("-p --paths <paths>", $("a comma seperated list of full paths to concatenate (e.g. '/someFolder/someFile.txt,/somefolder/somefile2.txt,/anotherFolder/newFile.txt')")).option("-d --destination <destination>", $("specify the target file that all of the files in --paths should be concatenated into (e.g /someFolder/targetFile.txt)")).option("-f --force", $("optionally indicates that the file or folder being created can overwrite the file or folder at path if it already exists (default is false). 'true' must be passed in for the overwrite to work")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __6(accountName, paths, destination, force, options, _) { var subscription, client, fileStatus; var __frame = { name: "__6", line: 270 }; return __func(_, this, arguments, __6, 5, __frame, function __$__6() {
      ...
      client = utils.createDataLakeStoreFileSystemManagementClient(subscription); return (function __$__6(__then) {
        ...
        paths = ("sources=" + paths);
        return withProgress(util.format($("Concatenating specified files into target location: %s"), destination), function __1(log, _) { var __frame = { name: "__1", line: 303 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {

            return client.fileSystem.msConcat(destination, accountName, paths, __cb(_, __frame, 1, 28, function __$__1() { _(); }, true)); }); }, __cb(_, __frame, 32, 6, function __$__6() {

          log.info($(("Successfully concatenated the file list into the specified item at path:  " + destination))); _(); }, true)); }); }); });


  dataLakeStoreFileSystem.command("move [accountName] [path] [destination] [force]").description($("Moves (renames) the specified file or folder into the specified destination file or folder.")).usage("[options] <accountName> <path> <destination> <force>").option("-n --accountName <accountName>", $("the Data Lake Store account name to execute the action on")).option("-p --path <path>", $("the path to the file or folder to move (e.g. /someFolder or /someFolder/someFile.txt)")).option("-d --destination <destination>", $("specify the target location to move the file or folder to")).option("-f --force", $("optionally indicates that the file or folder being created can overwrite the file or folder at path if it already exists (default is false). 'true' must be passed in for the overwrite to work")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __7(accountName, path, destination, force, options, _) { var subscription, client, response; var __frame = { name: "__7", line: 317 }; return __func(_, this, arguments, __7, 5, __frame, function __$__7() {
  ...
  dataLakeStoreFileSystem.command("addcontent [accountName] [path] [value]").description($("Appends the specified content to the end of the Data Lake Store file path specified.")).usage("[options] <accountName> <path> <value>").option("-n --accountName <accountName>", $("the Data Lake Store account name to execute the action on")).option("-p --path <path>", $("the full path to the file to add content to (e.g. /someFolder/someFile.txt)")).option("-v --value <value>", $("the contents to append to the file")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __8(accountName, path, value, options, _) { var subscription, clientOptions, client; var __frame = { name: "__8", line: 356 }; return __func(_, this, arguments, __8, 4, __frame, function __$__8() {
      ...
      client = utils.createDataLakeStoreFileSystemManagementClient(subscription, clientOptions);
      return withProgress(util.format($("Adding specified content to file %s"), path), function __1(log, _) { var response; var __frame = { name: "__1", line: 377 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {

          return client.fileSystem.internalBeginAppend(path, accountName, null, __cb(_, __frame, 1, 41, function ___(__0, __1) { response = __1;
            return client.fileSystem.append(response.location, value, __cb(_, __frame, 2, 26, function __$__1() { _(); }, true)); }, true)); }); }, __cb(_, __frame, 20, 6, function __$__8() {

        log.info($(("Successfully appended content at the specified path:  " + path))); _(); }, true)); }); });


  dataLakeStoreFileSystem.command("export [accountName] [path] [destination] [force]").description($("Downloads the specified file to the target location. NOTE: Only text files are supported by this command at present.")).usage("[options] <accountName> <path> <destination>").option("-n --accountName <accountName>", $("the Data Lake Store account name to execute the action on")).option("-p --path <path>", $("the full path in the Data Lake Store where the file should be imported to (e.g. /someFolder/someFile.txt")).option("-d --destination <destination>", $("the full local path to the file to import (e.g. /someFolder/someFile.txt or C:somefoldersomeFile.txt)")).option("-f --force", $("optionally indicates that the file being created can overwrite the file at path if it already exists (default is false).")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __9(accountName, path, destination, force, options, _) { var subscription, client, maxBytesToRead, fileStatus; var __frame = { name: "__9", line: 392 }; return __func(_, this, arguments, __9, 5, __frame, function __$__9() {
      ...
      return client.fileSystem.getFileStatus(path, accountName, __cb(_, __frame, 16, 41, function ___(__0, __2) { fileStatus = __2.fileStatus;
        ...
        return withProgress(util.format($("Downloading file %s to the specified location: %s"), path, destination), function __1(log, _) { var fileSizeInBytes, fileHandle, offset, bytesToRead, parameters, response; var __frame = { name: "__1", line: 411 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
                        ...
                        return _(new Error($(((("The file at path: " + destination) + " already exists. Please use the --force option to overwrite this file. Actual error reported: ") + err)))); } else { _(null, __result); } ; }, _); }); })(function ___() { __tryCatch(_, __then); }); } ; })(function __$__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                          ...
                          offset = 0; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$__1() { __more = false;
                              var __6 = (offset < fileSizeInBytes); if (__6) {
                                ...
                                return client.fileSystem.internalBeginOpen(path, accountName, parameters, __cb(_, __frame, 27, 45, function ___(__0, __3) { response = __3;
  ...
  dataLakeStoreFileSystem.command("read [accountName] [path] [length] [offset]").description($("Previews the specified Data Lake Store file starting at index 0 (or the specified offset) until the length is reached, displaying the results to the console.")).usage("[options] <accountName> <path> <length> <offset>").option("-n --accountName <accountName>", $("the Data Lake Store account name to execute the action on")).option("-p --path <path>", $("the full path to the file to download (e.g. /someFolder/someFile.txt)")).option("-l --length <length>", $("the length, in bytes, to read from the file")).option("-o --offset <offset>", $("the optional offset to begin reading at (default is 0)")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __10(accountName, path, length, offset, options, _) { var parameters, subscription, response; var __frame = { name: "__10", line: 462 }; return __func(_, this, arguments, __10, 5, __frame, function __$__10() {
      ...
      return withProgress(util.format($("Previewing contents of file %s"), path), function __1(log, _) { var client; var __frame = { name: "__1", line: 494 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {

          client = utils.createDataLakeStoreFileSystemManagementClient(subscription);
          return client.fileSystem.internalBeginOpen(path, accountName, parameters, __cb(_, __frame, 2, 37, function ___(__0, __1) { response = __1; _(); }, true)); }); }, __cb(_, __frame, 31, 6, function __$__10() {
  ...
  dataLakeStoreFileSystemPermissions.command("delete [accountName] [path] [defaultAcl]").description($("Deletes the entire ACL associated with a folder")).usage("[options] <accountName> <path> <default>").option("-n --accountName <accountName>", $("the Data Lake Store account name to execute the action on")).option("-p --path <path>", $("the full path to the folder to remove ACLs from (e.g. /someFolder)")).option("-d --defaultAcl", $("optionally indicates that the default ACL should be removed instead of the regular ACL. Default is false.")).option("-q, --quiet", $("quiet mode (do not ask for delete confirmation)")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __12(accountName, path, defaultAcl, options, _) { var subscription, client; var __frame = { name: "__12", line: 535 }; return __func(_, this, arguments, __12, 4, __frame, function __$__12() {
  ...
  dataLakeStoreAccount.command("show [accountName] [resource-group]").description($("Shows a Data Lake Store Account based on account name")).usage("[options] <accountName> <resource-group>").option("-n --accountName <accountName>", $("the Data Lake Store account name")).option("-g --resource-group <resource-group>", $("the optional resource group to list the accounts in")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __17(accountName, resourceGroup, options, _) { var subscription, client, dataLakeStoreAccount; var __frame = { name: "__17", line: 679 }; return __func(_, this, arguments, __17, 3, __frame, function __$__17() {
  ...
  dataLakeStoreAccount.command("delete [accountName] [resource-group]").description($("Deletes a Data Lake Store Account based on account name")).usage("[options] <accountName> <resource-group>").option("-n --accountName <accountName>", $("the Data Lake Store account name")).option("-g --resource-group <resource-group>", $("the optional resource group to force the command to find the Data Lake Store account to delete in.")).option("-q, --quiet", $("quiet mode (do not ask for delete confirmation)")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __18(accountName, resourceGroup, options, _) { var subscription, client, response; var __frame = { name: "__18", line: 703 }; return __func(_, this, arguments, __18, 3, __frame, function __$__18() {
  ...
  dataLakeStoreAccount.command("set [accountName] [resource-group] [defaultGroup]").description($("Updates the properties of an existing Data Lake Store Account")).usage("[options] <accountName> <resource-group> <defaultGroup>").option("-n --accountName <accountName>", $("The Data Lake Store account name to update with new tags and/or default permissions group")).option("-g --resource-group <resource-group>", $("the optional resource group to forcibly look for the account to update in")).option("-d --defaultGroup <defaultGroup>", $("the optional default permissions group to set in the existing account")).option("-t --tags <tags>", $(("Tags to set to the Data Lake Store account. Can be mutliple. " + "In the format of 'name=value'. Name is required and value is optional. For example, -t tag1=value1;tag2"))).option("--no-tags", $("remove all existing tags")).option("-s, --subscription <id>", $("the subscription identifier")).execute(function __20(accountName, resourceGroup, defaultGroup, options, _) { var subscription, client, dataLakeStoreAccount, tags; var __frame = { name: "__20", line: 756 }; return __func(_, this, arguments, __20, 4, __frame, function __$__20() {
  ...
  function createOrUpdateDataLakeStoreAccount(subscription, accountName, resourceGroup, location, defaultGroup, tags, _) { var client, create, accountParams, response; var __frame = { name: "createOrUpdateDataLakeStoreAccount", line: 782 }; return __func(_, this, arguments, createOrUpdateDataLakeStoreAccount, 6, __frame, function __$createOrUpdateDataLakeStoreAccount() {
      if (!accountName) {
        return _(null, cli.missingArgument("accountName")); } ;
  ...
  function listAllDataLakeStoreAccounts(subscription, resourceGroup, _) { var client, response, accounts; var __frame = { name: "listAllDataLakeStoreAccounts", line: 827 }; return __func(_, this, arguments, listAllDataLakeStoreAccounts, 2, __frame, function __$listAllDataLakeStoreAccounts() {
      client = utils.createDataLakeStoreManagementClient(subscription);
  ...
  function getResrouceGroupByAccountName(subscription, resourceGroup, name, _) { var accounts, i, acctId, rgStart, rgEnd; var __frame = { name: "getResrouceGroupByAccountName", line: 838 }; return __func(_, this, arguments, getResrouceGroupByAccountName, 3, __frame, function __$getResrouceGroupByAccountName() {
