...
exports.init = function(cli) {
  ...
  deployment.command("create [resource-group] [name]").description($("Creates a deployment")).option("-g --resource-group <resource-group>", $("the name of the resource group")).option("-n --name <name>", $("the name of the deployment")).fileRelatedOption("-f --template-file <template-file>", $("the path to the template file in the file system")).option("--template-uri <template-uri>", $("the uri to the remote template file")).option("--template-version <template-version>", $("the content version of the template")).option("-p --parameters <parameters>", $("a JSON-formatted string containing parameters")).fileRelatedOption("-e --parameters-file <parametersFile>", $("a file containing parameters")).option("--nowait", $("does not wait for the deployment to complete. Returns as soon as the deployment is created")).option("--novalidate", $("do not validate deployment")).option("--subscription <subscription>", $("the subscription identifier")).execute(function __1(resourceGroup, name, options, _) { var deployment, subscription, client; var __frame = { name: "__1", line: 46 }; return __func(_, this, arguments, __1, 3, __frame, function __$__1() {
      ...
      return groupUtils.createDeployment(cli, resourceGroup, name, options, __cb(_, __frame, 5, 34, function ___(__0, __2) { deployment = __2;
        subscription = profile.current.getSubscription(options.subscription);
        client = utils.createResourceClient(subscription); return (function __$__1(__then) {

          if (!options.nowait) {
            return cli.interaction.withProgress($("Waiting for deployment to complete"), function __1(log, _) { var __frame = { name: "__1", line: 57 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() { var __1 = true; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$__1() { __more = false;




                    var __3 = (__1 || ((deployment.properties.provisioningState === "Running") || (deployment.properties.provisioningState === "Accepted"))); if (__3) { __1 = false; return client.deployments.get(resourceGroup, deployment.name, __cb(_, __frame, 2, 44, function ___(__0, __2) { deployment = __2.deployment; return setTimeout(__cb(_, __frame, 3, 12, function __$__1() { while (__more) { __loop(); }; __more = true; }, true), 5000); }, true)); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(function __$__1() {

                  if ((deployment.properties.provisioningState !== "Succeeded")) {
                    log.error("Deployment provisioning state was not successful"); } ; _(); }); }); }, __cb(_, __frame, 10, 24, __then, true)); } else { __then(); } ; })(function __$__1() {





          displayDeployment(deployment, resourceGroup, true, cli.output); _(); }); }, true)); }); });


  deployment.command("list [resource-group] [state]").usage("[options] <resource-group> [state]").description($("Gets deployments")).option("-g --resource-group <resourceGroup>", $("the name of the resource group.")).option("--state <state>", $(("filter the deployments by provisioning state (valid " + "values are Accepted, Running, Failed, and Succeeded)"))).option("--subscription <subscription>", $("subscription containing deployments to list (optional)")).execute(function __2(resourceGroup, state, options, _) { var subscription, client, progress, allDeployments; var __frame = { name: "__2", line: 80 }; return __func(_, this, arguments, __2, 3, __frame, function __$__2() {
  ...
  deployment.command("show [resource-group] [name]").usage("[options] <resource-group> [deployment-name]").description($("Shows a deployment")).option("-g --resource-group <resourceGroup>", $("the name of the resource group.")).option("-n --name <name>", $("the name of the deployment (if not specified, the most recent deployment is shown)")).option("--subscription <subscription>", $("subscription containing the deployment to display (optional)")).execute(function __3(resourceGroup, name, options, _) { var subscription, client, progress, deployment, allDeployments; var __frame = { name: "__3", line: 114 }; return __func(_, this, arguments, __3, 3, __frame, function __$__3() {
      ...
      progress = cli.interaction.progress($("Getting deployments")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() { return (function __$__3(__then) {
              ...
              if (name) {
                return client.deployments.get(resourceGroup, name, __cb(_, __frame, 10, 42, function ___(__0, __1) { deployment = __1.deployment; __then(); }, true)); } else {
          ...
          if (deployment) {
            displayDeployment(deployment, resourceGroup, true, log); } ; _(); }); }); }); });



  deployment.command("stop [resource-group] [name]").usage("[options] <resource-group> [deployment-name]").description($("Stops a deployment")).option("-g --resource-group <resourceGroup>", $("the name of the resource group")).option("-q --quiet", $("quiet mode (do not ask for stop deployment confirmation)")).option("-n --name <name>", $("the name of the deployment (if not specified, the currently running deployment is stopped)")).option("--subscription <subscription>", $("the subscription identifier")).execute(function __4(resourceGroup, name, options, _) { var subscription, client, deploymentToStop, progress; var __frame = { name: "__4", line: 152 }; return __func(_, this, arguments, __4, 3, __frame, function __$__4() {
      ...
      deploymentToStop = name; return (function __$__4(__then) {
        ...
        if (!name) {
          return cli.interaction.withProgress($("Looking for \"Running\" or \"Accepted\" deployment"), function __1(log, _) { var allRunningDeployments, allAcceptedDeployments, allCancellableDeployments; var __frame = { name: "__1", line: 162 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {



              return retrieveDeployments(client, resourceGroup, "Running", __cb(_, __frame, 3, 40, function ___(__0, __1) { allRunningDeployments = __1;
                return retrieveDeployments(client, resourceGroup, "Accepted", __cb(_, __frame, 4, 41, function ___(__0, __2) { allAcceptedDeployments = __2;
          ...
          if (deploymentToStop) { return (function __$__4(_) {
              ...
              return cli.interaction.confirm(util.format($("Stop deployment %s? [y/n]: "), deploymentToStop), __cb(_, __frame, 37, 29, function ___(__0, __4) { var __3 = !__4; return _(null, __3); }, true)); })(__cb(_, __frame, -151, 17, function ___(__0, __3) { return (function __$__4(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$__4() {
...
function retrieveDeployments(client, resourceGroup, state, _) { var parameters, response, allDeployments, nextLink; var __frame = { name: "retrieveDeployments", line: 239 }; return __func(_, this, arguments, retrieveDeployments, 3, __frame, function __$retrieveDeployments() {
    parameters = { };
    if (state) {
