...
__.extend(RouteTable.prototype, {
        ...
        self.output.nameValue("Route table name", routeTable.routeTableName); return (function __$showRouteTableForSubnet__10(__then) {
          if (options.detailed) {
            return self.networkManagementClient.routes.getRouteTableWithDetails(routeTable.routeTableName, defaultDetailLevel, __cb(_, __frame, 11, 63, function ___(__0, __2) { gatewayDetails = __2;
              ...
              self.output.list("Routes", gatewayDetails.routeList, 2); __then(); }, true)); } else { __then(); } ; })(_); }, true)); }); },



  getRouteTableForSubnet: function getRouteTableForSubnet__11(vnetName, subnetName, _) { var self, progress, routeTable, __this = this; var __frame = { name: "getRouteTableForSubnet__11", line: 257 }; return __func(_, this, arguments, getRouteTableForSubnet__11, 2, __frame, function __$getRouteTableForSubnet__11() { self = __this;
  ...
  _parseRoute: function _parseRoute__12(routeName, addressPrefix, nextHopType, options, _) { var self, route, ipValidationResult, __this = this; var __frame = { name: "_parseRoute__12", line: 275 }; return __func(_, this, arguments, _parseRoute__12, 4, __frame, function __$_parseRoute__12() { self = __this;
