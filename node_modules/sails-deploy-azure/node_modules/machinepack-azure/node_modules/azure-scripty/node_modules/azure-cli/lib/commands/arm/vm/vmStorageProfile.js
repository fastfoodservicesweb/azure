...
__.extend(VMStorageProfile.prototype, {
  generateStorageProfile: function generateStorageProfile__1(_) { var storageProfile, containerUri, __this = this; var __frame = { name: "generateStorageProfile__1", line: 33 }; return __func(_, this, arguments, generateStorageProfile__1, 0, __frame, function __$generateStorageProfile__1() {
      storageProfile = {
        profile: { },
  ...
  generateDataDiskProfile: function generateDataDiskProfile__2(_) { var dataDiskInfo, lun, containerUri, __this = this; var __frame = { name: "generateDataDiskProfile__2", line: 80 }; return __func(_, this, arguments, generateDataDiskProfile__2, 0, __frame, function __$generateDataDiskProfile__2() {
  ...
  _generateDataDiskContainerURI: function _generateDataDiskContainerURI__3(_) { var containerUri, storageAccountInfo, __this = this; var __frame = { name: "_generateDataDiskContainerURI__3", line: 147 }; return __func(_, this, arguments, _generateDataDiskContainerURI__3, 0, __frame, function __$_generateDataDiskContainerURI__3() { return (function __$_generateDataDiskContainerURI__3(__then) {
  ...
  _parseOSDataDiskImageParams: function _parseOSDataDiskImageParams__4(params, _) { var osDiskDataDiskImageInfo, imageUrnParts, __this = this; var __frame = { name: "_parseOSDataDiskImageParams__4", line: 168 }; return __func(_, this, arguments, _parseOSDataDiskImageParams__4, 1, __frame, function __$_parseOSDataDiskImageParams__4() {
      osDiskDataDiskImageInfo = {
        ...
        if (params.imageUrn) {
          ...
          return __this._parseOSDiskParams(params, "FromImage", __cb(_, __frame, 24, 56, function ___(__0, __1) { osDiskDataDiskImageInfo.osDiskInfo = __1;
          ...
          return __this._parseOSDiskParams(params, "Attach", __cb(_, __frame, 30, 56, function ___(__0, __2) { osDiskDataDiskImageInfo.osDiskInfo = __2;
            if ((osDiskDataDiskImageInfo.osDiskInfo && !osDiskDataDiskImageInfo.osDiskInfo.isVhdParamAUrl)) {
  ...
  _parseOSDiskParams: function _parseOSDiskParams__5(params, createOption, _) { var attachMode, osType, useOsDisk, osDiskInfo, supportedDiskCaching, __this = this; var __frame = { name: "_parseOSDiskParams__5", line: 217 }; return __func(_, this, arguments, _parseOSDiskParams__5, 2, __frame, function __$_parseOSDiskParams__5() {
      ...
      osType = null; return (function __$_parseOSDiskParams__5(__then) {
        ...
        if ((__this.params.diskEncryptionKeyVaultId || __this.params.diskEncryptionKeySecretUrl)) {
          osDiskInfo.profile.encryptionSettings = {
            diskEncryptionKey: {
              sourceVault: {
                referenceUri: __this.params.diskEncryptionKeyVaultId },
        ...
        if ((__this.params.keyEncryptionKeyVaultId || __this.params.keyEncryptionKeyUrl)) {
          ...
          osDiskInfo.profile.encryptionSettings.keyEncryptionKey = {
            sourceVault: {
              referenceUri: __this.params.keyEncryptionKeyVaultId },
  ...
  _isStorageAccountNameAvailable: function _isStorageAccountNameAvailable__8(params, _) { var progress, result, __this = this; var __frame = { name: "_isStorageAccountNameAvailable__8", line: 430 }; return __func(_, this, arguments, _isStorageAccountNameAvailable__8, 1, __frame, function __$_isStorageAccountNameAvailable__8() {
  ...
  _createNewStorageAccount: function _createNewStorageAccount__9(resourceGroupName, params, _) { var createRequestProfile, progress, __this = this; var __frame = { name: "_createNewStorageAccount__9", line: 441 }; return __func(_, this, arguments, _createNewStorageAccount__9, 2, __frame, function __$_createNewStorageAccount__9() {
  ...
  _findStorageAccount: function _findStorageAccount__11(storageAccountName, _) { var progress, storageAccount, __this = this; var __frame = { name: "_findStorageAccount__11", line: 475 }; return __func(_, this, arguments, _findStorageAccount__11, 1, __frame, function __$_findStorageAccount__11() {
  ...
  _getPrefix: function _getPrefix__12(_) { var __this = this; var __frame = { name: "_getPrefix__12", line: 490 }; return __func(_, this, arguments, _getPrefix__12, 0, __frame, function __$_getPrefix__12() { return (function __$_getPrefix__12(__then) {
  ...
  _generateNewStorageAccountName: function _generateNewStorageAccountName__13(_) { var __this = this; var __frame = { name: "_generateNewStorageAccountName__13", line: 498 }; return __func(_, this, arguments, _generateNewStorageAccountName__13, 0, __frame, function __$_generateNewStorageAccountName__13() {
  ...
  _generateOSDiskName: function _generateOSDiskName__14(_) { var __this = this; var __frame = { name: "_generateOSDiskName__14", line: 502 }; return __func(_, this, arguments, _generateOSDiskName__14, 0, __frame, function __$_generateOSDiskName__14() {
