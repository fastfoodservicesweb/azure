...
exports.init = function(cli) {
  ...
  vault.command("list [resource-group]").description($("Lists existing vaults")).usage("[[--resource-group] <resource-group>] [options]").option("-g, --resource-group <resource-group>", $("lists only vaults belonging to the informed resource group")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __1(resourceGroup, options, _) { var parameters, subscription, client, resources, progress, i; var __frame = { name: "__1", line: 54 }; return __func(_, this, arguments, __1, 2, __frame, function __$__1() {
      ...
      progress = cli.interaction.progress($("Listing vaults")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {

            return client.resources.list(parameters, __cb(_, __frame, 36, 37, function ___(__0, __1) { resources = __1.resources;
              for (i = 0; (i < resources.length); ++i) {
                resources[i].resourceGroup = resourceUtils.getResourceInformation(resources[i].id).resourceGroup; }; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__1() {
  ...
  vault.command("create [vault-name]").description($("Creates a vault")).usage("[--vault-name] <vault-name> --resource-group <resource-group> --location <location> [options]").option("-u, --vault-name <vault-name>", $("the vault name; this is used to compute the vault's DNS name")).option("-g, --resource-group <resource-group>", $("the resource group name")).option("-l, --location <location>", $("Azure region in which to create the vault")).option("-x, --sku <sku>", util.format($("SKU setting, one of: [%s]"), SKU_TYPE.join(", "))).option("-t, --tags <tags>", $("Tags to set on the vault. Can be multiple in the format 'name=value'. Name is required and value is optional. For example, -t tag1=value1;tag2")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __2(vaultName, options, _) { var subscription, client, identity, vaultResource, objectId, properties, request; var __frame = { name: "__2", line: 123 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
      ...
      return withProgress($("Checking pre-condition"), function __1(log, _) { var resourceGroup; var __frame = { name: "__1", line: 161 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
        ...
        return getObjectId(subscription, null, null, __cb(_, __frame, 54, 21, function ___(__0, __4) { objectId = __4;
          ...
          return withProgress(util.format($("Creating vault %s"), options.vaultName), function __2(log, _) { var __frame = { name: "__2", line: 209 }; return __func(_, this, arguments, __2, 1, __frame, function __$__2() {

              return client.resources.createOrUpdate(options.resourceGroup, identity, request, __cb(_, __frame, 1, 34, function ___(__0, __2) { var __1 = __2.resource; return _(null, __1); }, true)); }); }, __cb(_, __frame, 85, 22, function ___(__0, __5) { vaultResource = __5;


            log.info(util.format($("Created vault %s"), (vaultResource.name || options.vaultName)));
            return showVault(vaultResource, __cb(_, __frame, 91, 6, function __$__2() {
  ...
  vault.command("set-attributes [vault-name]").description($("Changes attributes of an existing vault")).usage("[--vault-name] <vault-name> [options]").option("-u, --vault-name <vault-name>", $("the vault name")).option("-g, --resource-group <resource-group>", $("changes only if vault belongs to the informed resource group; otherwise returns 'not found'")).option("-x, --sku <sku>", util.format($("SKU setting, one of: [%s]"), SKU_TYPE.join(", "))).option("-t, --tags <tags>", $("Tags to set on the vault. Can be multiple in the format 'name=value'. Name is required and value is optional. For example, -t tag1=value1;tag2")).option("--reset-tags", $("remove previously existing tags; can combined with --tags")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __3(vaultName, options, _) { var subscription, client, identity, resourceGroup, vaultResource, properties, request; var __frame = { name: "__3", line: 232 }; return __func(_, this, arguments, __3, 2, __frame, function __$__3() {
      ...
      return withProgress(util.format($("Loading vault %s"), options.vaultName), function __1(log, _) { var __frame = { name: "__1", line: 264 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() { return (function __$__1(_) {

            var __1 = options.resourceGroup; if (__1) { return _(null, __1); } ; return getVaultResourceGroup(client, options.vaultName, __cb(_, __frame, 1, 51, _, true)); })(__cb(_, __frame, -263, 17, function ___(__0, __2) { resourceGroup = __2;
            if (!resourceGroup) {
              return _(null, null); } ;
        ...
        return withProgress(util.format($("Updating vault %s"), options.vaultName), function __2(log, _) { var __frame = { name: "__2", line: 312 }; return __func(_, this, arguments, __2, 1, __frame, function __$__2() {

            return client.resources.createOrUpdate(resourceGroup, identity, request, __cb(_, __frame, 1, 34, function ___(__0, __2) { var __1 = __2.resource; return _(null, __1); }, true)); }); }, __cb(_, __frame, 79, 22, function ___(__0, __4) { vaultResource = __4;


          log.info(util.format($("Vault %s was updated"), vaultName));
          return showVault(vaultResource, __cb(_, __frame, 85, 6, function __$__3() { _(); }, true)); }, true)); }, true)); }); });


  vault.command("show [vault-name]").description($("Shows properties of a vault")).usage("[--vault-name] <vault-name> [options]").option("-u, --vault-name <vault-name>", $("the vault name")).option("-g, --resource-group <resource-group>", $("shows only if vault belongs to the informed resource group; otherwise returns 'not found'")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __4(vaultName, options, _) { var subscription, client, identity, resourceGroup, vaultResource; var __frame = { name: "__4", line: 326 }; return __func(_, this, arguments, __4, 2, __frame, function __$__4() {
      ...
      return withProgress(util.format($("Loading vault %s"), options.vaultName), function __1(log, _) { var __frame = { name: "__1", line: 358 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() { return (function __$__1(_) {

            var __1 = options.resourceGroup; if (__1) { return _(null, __1); } ; return getVaultResourceGroup(client, options.vaultName, __cb(_, __frame, 1, 51, _, true)); })(__cb(_, __frame, -357, 17, function ___(__0, __2) { resourceGroup = __2;
            if (!resourceGroup) {
              return _(null, null); } ;
  ...
  vault.command("delete [vault-name]").description($("Deletes an existing vault")).usage("[--vault-name] <vault-name> [options]").option("-u, --vault-name <vault-name>", $("the vault name")).option("-g, --resource-group <resource-group>", $("deletes only if vault belongs to the informed resource group; otherwise returns 'not found'")).option("-q, --quiet", $("quiet mode (do not ask for delete confirmation)")).option("-p, --pass-thru", $("outputs the deleted vault")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __5(vaultName, options, _) { var subscription, client, identity, progress, resourceGroup; var __frame = { name: "__5", line: 382 }; return __func(_, this, arguments, __5, 2, __frame, function __$__5() {
      ...
      if (!options.vaultName) {
        ...
        var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete vault %s? [y/n] "), options.vaultName), __cb(_, __frame, 17, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -381, 17, function ___(__0, __3) { return (function __$__5(__then) { if (__3) {
          ...
          progress = cli.interaction.progress(util.format($("Deleting vault %s"), options.vaultName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__5() { return (function __$__5(_) {
                  ...
                  var __2 = options.resourceGroup; if (__2) { return _(null, __2); } ; return getVaultResourceGroup(client, options.vaultName, __cb(_, __frame, 36, 53, _, true)); })(__cb(_, __frame, -381, 17, function ___(__0, __4) { resourceGroup = __4;
                  if (!resourceGroup) {
                    return _(notFoundError(options.resourceGroup, options.vaultName)); } ;

                  return client.resources.deleteMethod(resourceGroup, identity, __cb(_, __frame, 40, 25, function __$__5() { _(null, null, true); }, true)); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__5() {
  ...
  vault.command("set-policy [vault-name]").description($("Adds or modifies an access policy for a vault")).usage("[--vault-name] <vault-name> [options]").option("-u, --vault-name <vault-name>", $("the vault name")).option("-g, --resource-group <resource-group>", $("changes only if vault belongs to the informed resource group; otherwise returns 'not found'")).option("--object-id <object-id>", $("a GUID that identifies the principal that will receive permissions")).option("--spn <service-principal-name>", $("name of a service principal that will receive permissions")).option("--upn <user-principal-name>", $("name of a user principal that will receive permissions")).option("--perms-to-keys <perms-to-keys>", util.format($("JSON-encoded array of strings representing key operations; each string can be one of [%s]"), KEY_PERMS.join(", "))).option("--perms-to-secrets <perms-to-secrets>", util.format($("JSON-encoded array of strings representing secret operations; each string can be one of [%s]"), SECRET_PERMS.join(", "))).option("--enabled-for-deployment <boolean>", $("specifies whether the Azure Compute resource provider can access secrets")).option("--enabled-for-template-deployment <boolean>", $("specifies whether Azure Resource Manager can access secrets")).option("--enabled-for-disk-encryption <boolean>", $("specifies whether Azure Disk Encryption can access secrets")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __6(vaultName, options, _) { var v, extraneous, subscription, client, identity, resourceGroup, vaultResource, properties, policies, policy, index, request; var __frame = { name: "__6", line: 443 }; return __func(_, this, arguments, __6, 2, __frame, function __$__6() {
      ...
      if (((((!options.permsToKeys && !options.permsToSecrets) && __.isUndefined(options.enabledForDeployment)) && __.isUndefined(options.enabledForTemplateDeployment)) && __.isUndefined(options.enabledForDiskEncryption))) {
        ...
        return withProgress(util.format($("Loading vault %s"), options.vaultName), function __1(log, _) { var __frame = { name: "__1", line: 527 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() { return (function __$__1(_) {

              var __1 = options.resourceGroup; if (__1) { return _(null, __1); } ; return getVaultResourceGroup(client, options.vaultName, __cb(_, __frame, 1, 51, _, true)); })(__cb(_, __frame, -526, 17, function ___(__0, __2) { resourceGroup = __2;
              if (!resourceGroup) {
                return _(null, null); } ;
  ...
  vault.command("delete-policy [vault-name]").description($("Removes an access policy from a vault")).usage("[--vault-name] <vault-name> [options]").option("-u, --vault-name <vault-name>", $("the vault name")).option("-g, --resource-group <resource-group>", $("deletes only if vault belongs to the informed resource group; otherwise returns 'not found'")).option("--object-id <object-id>", $("a GUID that identifies the principal that will lose permissions")).option("--spn <service-principal-name>", $("name of a service principal that will lose permissions")).option("--upn <user-principal-name>", $("name of a user principal that will lose permissions")).option("--enabled-for-deployment", $("if provided, will set the enabledForDeployment property to false in the vault")).option("--enabled-for-template-deployment", $("if provided, will set the enabledForTemplateDeployment property to false in the vault")).option("--enabled-for-disk-encryption", $("if provided, will set the enabledForDiskEncryption property to false in the vault")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __7(vaultName, options, _) { var v, subscription, client, identity, resourceGroup, vaultResource, properties, changed, policies, previousLength, request; var __frame = { name: "__7", line: 632 }; return __func(_, this, arguments, __7, 2, __frame, function __$__7() {
      ...
      if ((v.length > 1)) {
        ...
        return withProgress(util.format($("Loading vault %s"), options.vaultName), function __1(log, _) { var __frame = { name: "__1", line: 689 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() { return (function __$__1(_) {

              var __1 = options.resourceGroup; if (__1) { return _(null, __1); } ; return getVaultResourceGroup(client, options.vaultName, __cb(_, __frame, 1, 51, _, true)); })(__cb(_, __frame, -688, 17, function ___(__0, __2) { resourceGroup = __2;
              if (!resourceGroup) {
                return _(null, null); } ;
          ...
          return withProgress(util.format($("Updating vault %s"), options.vaultName), function __2(log, _) { var __frame = { name: "__2", line: 771 }; return __func(_, this, arguments, __2, 1, __frame, function __$__2() {

              return client.resources.createOrUpdate(resourceGroup, identity, request, __cb(_, __frame, 1, 34, function ___(__0, __2) { var __1 = __2.resource; return _(null, __1); }, true)); }); }, __cb(_, __frame, 138, 22, function ___(__0, __5) { vaultResource = __5;


            log.info(util.format($("Vault %s was updated"), options.vaultName));
            return showVault(vaultResource, __cb(_, __frame, 144, 6, function __$__7() { _(); }, true)); }, true)); }, true)); }); }); });
  ...
  function getVaultResourceGroup(client, vaultName, _) { var parameters, resources, i, resourceInformation, name; var __frame = { name: "getVaultResourceGroup", line: 790 }; return __func(_, this, arguments, getVaultResourceGroup, 2, __frame, function __$getVaultResourceGroup() {
      log.verbose(util.format($("Loading resource group of vault %s"), vaultName));
      parameters = {
        resourceType: RESOURCE_TYPE };

      return client.resources.list(parameters, __cb(_, __frame, 5, 37, function ___(__0, __1) { resources = __1.resources;
        for (i = 0; (i < resources.length); i++) {
  ...
  function getObjectId(subscription, servicePrincipalName, userPrincipalName, _) { var account; var __frame = { name: "getObjectId", line: 816 }; return __func(_, this, arguments, getObjectId, 3, __frame, function __$getObjectId() { return (function __$getObjectId(__then) {
        ...
        if (servicePrincipalName) {
          return getAccountBySPN(servicePrincipalName, __cb(_, __frame, 4, 16, function ___(__0, __1) { account = __1; __then(); }, true)); } else { return (function __$getObjectId(__then) {
            if (userPrincipalName) {
              ...
              return getAccountFromSubscription(subscription, __cb(_, __frame, 9, 16, function ___(__0, __3) { account = __3; __then(); }, true)); } ; })(__then); } ; })(function __$getObjectId() {
  ...
  function getAccountBySPN(spn, _) { var graphClient, accounts; var __frame = { name: "getAccountBySPN", line: 832 }; return __func(_, this, arguments, getAccountBySPN, 1, __frame, function __$getAccountBySPN() {

      log.verbose(util.format($("Getting account for SPN %s"), spn));

      graphClient = getGraphClient();
      return graphClient.servicePrincipal.getByServicePrincipalName(spn, __cb(_, __frame, 5, 48, function ___(__0, __1) { accounts = __1.servicePrincipals;
  ...
  function getAccountByUPN(upn, _) { var graphClient, accounts; var __frame = { name: "getAccountByUPN", line: 847 }; return __func(_, this, arguments, getAccountByUPN, 1, __frame, function __$getAccountByUPN() {

      log.verbose(util.format($("Getting account for UPN %s"), upn));

      graphClient = getGraphClient();
      return graphClient.user.getBySignInName(upn, __cb(_, __frame, 5, 36, function ___(__0, __1) { accounts = __1.users;
        if ((!accounts || (accounts.length === 0))) {
  ...
  function getAccountFromSubscription(subscription, _) { var __frame = { name: "getAccountFromSubscription", line: 862 }; return __func(_, this, arguments, getAccountFromSubscription, 1, __frame, function __$getAccountFromSubscription() {
  ...
  function showVault(resource, _) { var resourceInformation, accessPolicies, i; var __frame = { name: "showVault", line: 893 }; return __func(_, this, arguments, showVault, 1, __frame, function __$showVault() {
      if (!resource.name) {
  ...
  function resolvePrincipalName(accessPolicy, _) { var client, servicePrincipal, user; var __frame = { name: "resolvePrincipalName", line: 912 }; return __func(_, this, arguments, resolvePrincipalName, 1, __frame, function __$resolvePrincipalName() {
      ...
      client = getGraphClient(); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$resolvePrincipalName() {


            return client.servicePrincipal.get(accessPolicy.objectId, __cb(_, __frame, 11, 53, function ___(__0, __1) { servicePrincipal = __1.servicePrincipal;
              if (servicePrincipal) {
                ...
                return client.user.get(accessPolicy.objectId, __cb(_, __frame, 20, 29, function ___(__0, __2) { user = __2.user;
                  if (user) {
