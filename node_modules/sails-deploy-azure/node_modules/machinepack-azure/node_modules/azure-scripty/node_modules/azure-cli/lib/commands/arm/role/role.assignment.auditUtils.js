...
exports.processInsightsResults = function exports_processInsightsResults__1(cli, log, insightsResults, subscription, graphClient, authzClient, _) { var startEvents, endEvents, offlineEvents, i, outputData, principalDetailsCache, roleDefinitionCache, result, j, se, out, endEvent, startEvent, scope, messageBody, properties, principalId, index, resourceDetails, roleId, oe, outOffline, offlineEvent; var __frame = { name: "exports_processInsightsResults__1", line: 24 }; return __func(_, this, arguments, exports_processInsightsResults__1, 6, __frame, function __$exports_processInsightsResults__1() {
    ...
    return authzClient.roleDefinitions.list(__cb(_, __frame, 22, 43, function ___(__0, __3) { result = __3;
                      ...
                      properties = toCamelCaseObj(properties); return (function __$exports_processInsightsResults__1(__then) {
                        ...
                        if (properties) {
                          ...
                          out["PrincipalId"] = principalId; return (function __$exports_processInsightsResults__1(__then) {
                            if (principalId) {
                              return getPrincipalDetails(principalId, principalDetailsCache, graphClient, __cb(_, __frame, 68, 12, function __$exports_processInsightsResults__1() {
...
function getPrincipalDetails(principalId, principalDetailsCache, graphClient, _) { var principalDetails, user, group, sp; var __frame = { name: "getPrincipalDetails", line: 217 }; return __func(_, this, arguments, getPrincipalDetails, 3, __frame, function __$getPrincipalDetails() {
    ...
    principalDetails = { }; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$getPrincipalDetails() {
          ...
          return graphClient.user.get(principalId, __cb(_, __frame, 9, 28, function ___(__0, __1) { user = __1.user; __then(); }, true)); }); })(function ___(ex, __result) { __catch(function __$getPrincipalDetails() { if (ex) {
          ...
          if (user) {
            ...
            principalDetailsCache[principalId] = principalDetails; __then(); } else { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$getPrincipalDetails() {
                  ...
                  return graphClient.group.get(principalId, __cb(_, __frame, 23, 32, function ___(__0, __2) { group = __2.group; __then(); }, true)); }); })(function ___(ex, __result) { __catch(function __$getPrincipalDetails() { if (ex) {
                  ...
                  if (group) {
                    ...
                    principalDetailsCache[principalId] = principalDetails; __then(); } else { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$getPrincipalDetails() {
                          ...
                          return graphClient.servicePrincipal.get(principalId, __cb(_, __frame, 37, 42, function ___(__0, __3) { sp = __3.servicePrincipal; __then(); }, true)); }); })(function ___(ex, __result) { __catch(function __$getPrincipalDetails() { if (ex) {
