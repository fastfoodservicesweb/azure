...
__.extend(AppGateway.prototype, {
  create: function create__1(appGatewayName, vnetName, subnetNames, options, _) { var self, appGateway, appGatewayConfig, progress, __this = this; var __frame = { name: "create__1", line: 33 }; return __func(_, this, arguments, create__1, 4, __frame, function __$create__1() { self = __this;

      options.subnetNames = subnetNames;
      return self.get(appGatewayName, __cb(_, __frame, 3, 26, function ___(__0, __1) { appGateway = __1;
        if (appGateway) {
          return _(new Error(util.format($("Application Gateway \"%s\" already exists"), appGatewayName))); } ;


        appGatewayConfig = { };
        self._validateAppGatewayOptions(appGatewayName, vnetName, appGatewayConfig, options, true);

        progress = self.interaction.progress(util.format($("Creating an Application Gateway \"%s\" for virtual network \"%s\""), appGatewayName, vnetName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$create__1() {

              return self.networkManagementClient.applicationGateways.create(appGatewayConfig, __cb(_, __frame, 13, 55, function __$create__1() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$create__1() {
  ...
  set: function set__2(appGatewayName, vnetName, options, _) { var self, appGateway, progress, __this = this; var __frame = { name: "set__2", line: 52 }; return __func(_, this, arguments, set__2, 3, __frame, function __$set__2() { self = __this;
      ...
      return self.get(appGatewayName, __cb(_, __frame, 2, 26, function ___(__0, __1) { appGateway = __1;
        ...
        progress = self.interaction.progress(util.format($("Updating an Application Gateway \"%s\" for virtual network \"%s\""), appGatewayName, vnetName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$set__2() {

              return self.networkManagementClient.applicationGateways.update(appGatewayName, appGateway, __cb(_, __frame, 10, 55, function __$set__2() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$set__2() {
  ...
  get: function get__3(appGatewayName, _) { var self, progress, appGateway, __this = this; var __frame = { name: "get__3", line: 68 }; return __func(_, this, arguments, get__3, 1, __frame, function __$get__3() { self = __this;
  ...
  show: function show__4(appGatewayName, options, _) { var self, appGateway, __this = this; var __frame = { name: "show__4", line: 84 }; return __func(_, this, arguments, show__4, 2, __frame, function __$show__4() { self = __this;
  ...
  list: function list__5(options, _) { var self, progress, appGateways, __this = this; var __frame = { name: "list__5", line: 114 }; return __func(_, this, arguments, list__5, 1, __frame, function __$list__5() { self = __this;
  ...
  delete: function delete__6(appGatewayName, options, _) { var self, progress, __this = this; var __frame = { name: "delete__6", line: 142 }; return __func(_, this, arguments, delete__6, 2, __frame, function __$delete__6() { self = __this; return (function __$delete__6(_) {

        var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Delete Application Gateway \"%s\"? [y/n] "), appGatewayName), __cb(_, __frame, 2, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -141, 17, function ___(__0, __2) { return (function __$delete__6(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$delete__6() {
  ...
  start: function start__7(appGatewayName, options, _) { var self, progress, __this = this; var __frame = { name: "start__7", line: 156 }; return __func(_, this, arguments, start__7, 2, __frame, function __$start__7() { self = __this;
  ...
  stop: function stop__8(appGatewayName, options, _) { var self, progress, __this = this; var __frame = { name: "stop__8", line: 167 }; return __func(_, this, arguments, stop__8, 2, __frame, function __$stop__8() { self = __this;
  ...
  showConfig: function showConfig__9(appGatewayName, options, _) { var self, config, __this = this; var __frame = { name: "showConfig__9", line: 178 }; return __func(_, this, arguments, showConfig__9, 2, __frame, function __$showConfig__9() { self = __this;
  ...
  exportConfig: function exportConfig__10(appGatewayName, filePath, options, _) { var self, gateway, config, __this = this; var __frame = { name: "exportConfig__10", line: 242 }; return __func(_, this, arguments, exportConfig__10, 3, __frame, function __$exportConfig__10() { self = __this;
  ...
  importConfig: function importConfig__11(appGatewayName, filePath, options, _) { var self, appGateway, configAsString, config, __this = this; var __frame = { name: "importConfig__11", line: 258 }; return __func(_, this, arguments, importConfig__11, 3, __frame, function __$importConfig__11() { self = __this;
  ...
  getConfig: function getConfig__12(appGatewayName, _) { var self, progress, config, __this = this; var __frame = { name: "getConfig__12", line: 272 }; return __func(_, this, arguments, getConfig__12, 1, __frame, function __$getConfig__12() { self = __this;
  ...
  setConfig: function setConfig__13(appGatewayName, config, _) { var self, progress, __this = this; var __frame = { name: "setConfig__13", line: 290 }; return __func(_, this, arguments, setConfig__13, 2, __frame, function __$setConfig__13() { self = __this;
  ...
  addBackendAddressPool: function addBackendAddressPool__14(appGatewayName, poolName, options, _) { var self, dnsServers, config, pool, addressPool, __this = this; var __frame = { name: "addBackendAddressPool__14", line: 301 }; return __func(_, this, arguments, addBackendAddressPool__14, 3, __frame, function __$addBackendAddressPool__14() { self = __this;
          ...
          if (config) {
            index = utils.indexOfCaseIgnore(config.backendAddressPools, { name: poolName }); return (function __$removeBackendAddressPool__15(__then) {
              if ((index !== -1)) { return (function __$removeBackendAddressPool__15(_) {
                  var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Delete a backend address pool \"%s?\" [y/n] "), poolName), __cb(_, __frame, 6, 48, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -322, 17, function ___(__0, __3) { return (function __$removeBackendAddressPool__15(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$removeBackendAddressPool__15() {
  ...
  addHttpSettings: function addHttpSettings__16(appGatewayName, httpSettingsName, options, _) { var self, httpSettings, config, settings, __this = this; var __frame = { name: "addHttpSettings__16", line: 342 }; return __func(_, this, arguments, addHttpSettings__16, 3, __frame, function __$addHttpSettings__16() { self = __this;
  ...
  removeHttpSettings: function removeHttpSettings__17(appGatewayName, httpSettingsName, options, _) { var self, config, index, __this = this; var __frame = { name: "removeHttpSettings__17", line: 359 }; return __func(_, this, arguments, removeHttpSettings__17, 3, __frame, function __$removeHttpSettings__17() { self = __this;
  ...
  addFrontendIp: function addFrontendIp__18(appGatewayName, frontendIpName, options, _) { var self, frontendIp, config, ip, __this = this; var __frame = { name: "addFrontendIp__18", line: 378 }; return __func(_, this, arguments, addFrontendIp__18, 3, __frame, function __$addFrontendIp__18() { self = __this;
  ...
  removeFrontendIp: function removeFrontendIp__19(appGatewayName, frontendIpName, options, _) { var self, config, index, __this = this; var __frame = { name: "removeFrontendIp__19", line: 395 }; return __func(_, this, arguments, removeFrontendIp__19, 3, __frame, function __$removeFrontendIp__19() { self = __this;
      ...
      return self.getConfig(appGatewayName, __cb(_, __frame, 2, 22, function ___(__0, __2) { config = __2;
        ...
        if ((index === -1)) {
          ...
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Delete a frontend ip \"%s?\" [y/n] "), frontendIpName), __cb(_, __frame, 12, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -394, 17, function ___(__0, __3) { return (function __$removeFrontendIp__19(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$removeFrontendIp__19() {
  ...
  addFrontendPort: function addFrontendPort__20(appGatewayName, frontendPortName, port, options, _) { var self, config, frontendPort, __this = this; var __frame = { name: "addFrontendPort__20", line: 415 }; return __func(_, this, arguments, addFrontendPort__20, 4, __frame, function __$addFrontendPort__20() { self = __this;
  ...
  removeFrontendPort: function removeFrontendPort__21(appGatewayName, frontendPortName, options, _) { var self, config, index, __this = this; var __frame = { name: "removeFrontendPort__21", line: 435 }; return __func(_, this, arguments, removeFrontendPort__21, 3, __frame, function __$removeFrontendPort__21() { self = __this;
      ...
      return self.getConfig(appGatewayName, __cb(_, __frame, 2, 22, function ___(__0, __2) { config = __2;
        ...
        if ((index === -1)) {
          ...
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Delete a frontend port \"%s?\" [y/n] "), frontendPortName), __cb(_, __frame, 12, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -434, 17, function ___(__0, __3) { return (function __$removeFrontendPort__21(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$removeFrontendPort__21() {
  ...
  addHttpListener: function addHttpListener__22(appGatewayName, httpListenerName, frontendPortName, options, _) { var self, config, httpListener, protocol, __this = this; var __frame = { name: "addHttpListener__22", line: 455 }; return __func(_, this, arguments, addHttpListener__22, 4, __frame, function __$addHttpListener__22() { self = __this;
  ...
  removeHttpListener: function removeHttpListener__23(appGatewayName, httpListenerName, options, _) { var self, config, index, __this = this; var __frame = { name: "removeHttpListener__23", line: 504 }; return __func(_, this, arguments, removeHttpListener__23, 3, __frame, function __$removeHttpListener__23() { self = __this;
      ...
      return self.getConfig(appGatewayName, __cb(_, __frame, 2, 22, function ___(__0, __2) { config = __2;
        ...
        if ((index === -1)) {
          ...
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Delete http listener \"%s?\" [y/n] "), httpListenerName), __cb(_, __frame, 12, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -503, 17, function ___(__0, __3) { return (function __$removeHttpListener__23(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$removeHttpListener__23() {
  ...
  addLoadBalancingRule: function addLoadBalancingRule__24(appGatewayName, ruleName, httpSettingsName, httpListenerName, addressPoolName, options, _) { var self, config, lbRule, __this = this; var __frame = { name: "addLoadBalancingRule__24", line: 524 }; return __func(_, this, arguments, addLoadBalancingRule__24, 6, __frame, function __$addLoadBalancingRule__24() { self = __this;
  ...
  removeLoadBalancingRule: function removeLoadBalancingRule__25(appGatewayName, ruleName, options, _) { var self, config, index, __this = this; var __frame = { name: "removeLoadBalancingRule__25", line: 568 }; return __func(_, this, arguments, removeLoadBalancingRule__25, 3, __frame, function __$removeLoadBalancingRule__25() { self = __this;
      ...
      return self.getConfig(appGatewayName, __cb(_, __frame, 2, 22, function ___(__0, __2) { config = __2;
        ...
        if ((index === -1)) {
          ...
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Delete http listener \"%s?\" [y/n] "), ruleName), __cb(_, __frame, 12, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -567, 17, function ___(__0, __3) { return (function __$removeLoadBalancingRule__25(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$removeLoadBalancingRule__25() {
  ...
  addSsl: function addSsl__26(appGatewayName, certName, options, _) { var self, certificateObject, certFormat, data, progress, __this = this; var __frame = { name: "addSsl__26", line: 588 }; return __func(_, this, arguments, addSsl__26, 3, __frame, function __$addSsl__26() { self = __this;
      ...
      progress = self.interaction.progress(util.format($("Adding SSL certificate \"%s\" to Application Gateway \"%s\""), certName, appGatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$addSsl__26() {
            ...
            return self.networkManagementClient.applicationGateways.addCertificate(appGatewayName, certName, certificateObject, options, __cb(_, __frame, 20, 55, function __$addSsl__26() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$addSsl__26() {
  ...
  removeSsl: function removeSsl__27(appGatewayName, certName, options, _) { var self, progress, __this = this; var __frame = { name: "removeSsl__27", line: 614 }; return __func(_, this, arguments, removeSsl__27, 3, __frame, function __$removeSsl__27() { self = __this; return (function __$removeSsl__27(_) {

        var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Remove certificate \"%s\" from Application Gateway \"%s\"? [y/n] "), certName, appGatewayName), __cb(_, __frame, 2, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -613, 17, function ___(__0, __2) { return (function __$removeSsl__27(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$removeSsl__27() {
