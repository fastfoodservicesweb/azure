...
__.extend(VirtualMachine.prototype, {
      ...
      progress = __this.cli.interaction.progress($("Getting virtual machines")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$getVMList__5() { return (function __$getVMList__5(__then) {
              ...
              if (resourceGroupName) {
                return __this.serviceClients.computeManagementClient.virtualMachines.list(resourceGroupName, __cb(_, __frame, 7, 74, function ___(__0, __1) { vms = __1;
                  ...
                  i = 0; var __7 = false; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$getVMList__5() { __more = false; if (__7) { i++; } else { __7 = true; } ; var __6 = (i < vms.virtualMachines.length); if (__6) {
                        vm = vms.virtualMachines[i];
                ...
                return __this.serviceClients.computeManagementClient.virtualMachines.listAll(__cb(_, __frame, 15, 74, function ___(__0, __3) { vms = __3;
                  ...
                  i = 0; var __11 = false; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$getVMList__5() { __more = false; if (__11) { i++; } else { __11 = true; } ; var __10 = (i < vms.virtualMachines.length); if (__10) {
                        vm = vms.virtualMachines[i];
  ...
  getInstanceView: function getInstanceView__13(resourceGroupName, vmName, _) { var progress, result, __this = this; var __frame = { name: "getInstanceView__13", line: 164 }; return __func(_, this, arguments, getInstanceView__13, 2, __frame, function __$getInstanceView__13() {
      progress = __this.cli.interaction.progress(util.format($("Getting instance view of virtual machine \"%s\""), vmName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$getInstanceView__13() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$getInstanceView__13() {
                  ...
                  return __this.serviceClients.computeManagementClient.virtualMachines.getWithInstanceView(resourceGroupName, vmName, __cb(_, __frame, 3, 79, function ___(__0, __1) { result = __1;
  ...
  createOrUpdateVM: function createOrUpdateVM__14(resourceGroupName, virtualMachine, isNewVM, _) { var progressMessage, progress, vmResult, __this = this; var __frame = { name: "createOrUpdateVM__14", line: 179 }; return __func(_, this, arguments, createOrUpdateVM__14, 3, __frame, function __$createOrUpdateVM__14() {
      ...
      progress = __this.cli.interaction.progress(progressMessage); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$createOrUpdateVM__14() {
            ...
            return __this.serviceClients.computeManagementClient.virtualMachines.createOrUpdate(resourceGroupName, virtualMachine, __cb(_, __frame, 18, 81, function ___(__0, __1) { vmResult = __1;
              if (vmResult.error) {
  ...
  getVMSizesByVMName: function getVMSizesByVMName__15(resourceGroupName, vmName, _) { var sizeResult, progress, __this = this; var __frame = { name: "getVMSizesByVMName__15", line: 207 }; return __func(_, this, arguments, getVMSizesByVMName__15, 2, __frame, function __$getVMSizesByVMName__15() {
  ...
  getVMSizesByLocationName: function getVMSizesByLocationName__16(location, _) { var sizeResult, progress, __this = this; var __frame = { name: "getVMSizesByLocationName__16", line: 219 }; return __func(_, this, arguments, getVMSizesByLocationName__16, 1, __frame, function __$getVMSizesByLocationName__16() {
  ...
  getVMExtension: function getVMExtension__17(resourceGroupName, vmName, extensionName, _) { var progress, result, __this = this; var __frame = { name: "getVMExtension__17", line: 231 }; return __func(_, this, arguments, getVMExtension__17, 3, __frame, function __$getVMExtension__17() {
      progress = __this.cli.interaction.progress(util.format($("Looking up extension \"%s\", VM: \"%s\""), extensionName, vmName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$getVMExtension__17() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$getVMExtension__17() {
                  ...
                  return __this.serviceClients.computeManagementClient.virtualMachineExtensions.getWithInstanceView(resourceGroupName, vmName, extensionName, __cb(_, __frame, 3, 88, function ___(__0, __1) { result = __1;
  ...
  createOrUpdateVMExtension: function createOrUpdateVMExtension__18(resourceGroupName, vmName, vmExtension, isNewExtension, _) { var progressMessage, progress, result, __this = this; var __frame = { name: "createOrUpdateVMExtension__18", line: 246 }; return __func(_, this, arguments, createOrUpdateVMExtension__18, 4, __frame, function __$createOrUpdateVMExtension__18() {
      ...
      progress = __this.cli.interaction.progress(progressMessage); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$createOrUpdateVMExtension__18() {
            ...
            return __this.serviceClients.computeManagementClient.virtualMachineExtensions.createOrUpdate(resourceGroupName, vmName, vmExtension, __cb(_, __frame, 4, 88, function ___(__0, __1) { result = __1;
  ...
  deleteVMExtension: function deleteVMExtension__19(resourceGroupName, vmName, extensionName, _) { var progress, result, __this = this; var __frame = { name: "deleteVMExtension__19", line: 257 }; return __func(_, this, arguments, deleteVMExtension__19, 3, __frame, function __$deleteVMExtension__19() {
      ...
      memoize[referenceUri] = vm; return (function __$_expandVM__20(__then) {
        ...
        if (utils.hasValidProperty(virtualMachine, "networkProfile")) {
          networkProfile = virtualMachine.networkProfile; return (function __$_expandVM__20(__then) {
            if ((networkProfile.networkInterfaces instanceof Array)) {
              i = 0; var __4 = false; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$_expandVM__20() { __more = false; if (__4) { i++; } else { __4 = true; } ; var __3 = (i < networkProfile.networkInterfaces.length); if (__3) {
                    ...
                    netReferenceUri = networkInterface.referenceUri.toLocaleLowerCase(); return (function __$_expandVM__20(__then) {
          ...
          if (utils.hasValidProperty(virtualMachine, "availabilitySetReference")) {
            availabilitySetRef = virtualMachine.availabilitySetReference; return (function __$_expandVM__20(__then) {
              if (((availabilitySetRef.referenceUri !== null) && (availabilitySetRef.referenceUri !== undefined))) {
                availReferenceUri = availabilitySetRef.referenceUri.toLocaleLowerCase(); return (function __$_expandVM__20(__then) {
  ...
  _getVMPowerState: function _getVMPowerState__21(resourceGroupName, vmName, _) { var intanceViewResult, statuses, i, __this = this; var __frame = { name: "_getVMPowerState__21", line: 308 }; return __func(_, this, arguments, _getVMPowerState__21, 2, __frame, function __$_getVMPowerState__21() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$_getVMPowerState__21() {

            return __this.serviceClients.computeManagementClient.virtualMachines.getWithInstanceView(resourceGroupName, vmName, __cb(_, __frame, 2, 90, function ___(__0, __1) { intanceViewResult = __1;
              statuses = intanceViewResult.virtualMachine.instanceView.statuses;
