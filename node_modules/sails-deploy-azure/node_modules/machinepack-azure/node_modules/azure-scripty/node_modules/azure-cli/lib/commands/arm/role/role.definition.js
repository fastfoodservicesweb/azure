...
exports.init = function(cli) {
  ...
  role.command("list").description($("Lists Azure RBAC roles available for assignment. Use this command to determine what actions on what resource types an Azure RBAC role allows.")).usage((((("\n" + "\n           -----    Example 1   -------") + "\n           azure role list") + "\n           Lists all RBAC role definitions.") + "\n")).option("--custom", $("If specified, display only the custom role definitions instead of all role definitions.")).option("-d --detailed", $("If specified, displays all the properties of a role definition")).option("--subscription <subscription>", $("Name or identifier of the subscription to list the roles for.")).execute(function __1(options, _) { var subscription, client, progress, result, hideDetails, roles; var __frame = { name: "__1", line: 44 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
      ...
      progress = cli.interaction.progress($("Listing role definitions")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {


            return client.roleDefinitions.list(__cb(_, __frame, 6, 38, function ___(__0, __1) { result = __1; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__1() {
          ...
          roles = roleUtils.getRoleDefinitionsWithNormalizedId(result.roleDefinitions);
  ...
  role.command("show [name] [id]").description($("Search for a role definition with role name or id to view its details. To inspect individual operations that a role grants access to, review the Actions and NotActions properties of the role.")).usage((((((((("[name] [id]" + "\n") + "\n           -----    Example 1   -------") + "\n           azure role show --name Reader") + "\n           Get the Reader role definition.") + "\n           -----    Example 2   -------") + "\n           azure role show --id 52a6cc13-ff92-47a8-a39b-2a8205c3087e") + "\n           Get the Reader role definition.") + "\n")).option("-n --name <name>", $("Role definition name. For e.g. Reader, Contributor, Virtual Machine Contributor.")).option("--id <id>", $("Role definition Id.")).option("--subscription <subscription>", $("Name or identifier of the subscription to search the role definition in.")).execute(function __2(name, id, options, _) { var subscription, client, progress, result, filterParameters, roles; var __frame = { name: "__2", line: 93 }; return __func(_, this, arguments, __2, 3, __frame, function __$__2() {
      ...
      result = []; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() { return (function __$__2(__then) {

              if (name) {
                filterParameters = { roleName: name };
                return client.roleDefinitions.listWithFilters(filterParameters, __cb(_, __frame, 14, 42, function ___(__0, __1) { result = __1.roleDefinitions; __then(); }, true)); } else {


                return client.roleDefinitions.get(id, __cb(_, __frame, 17, 45, function ___(__0, __2) { result.push(__2.roleDefinition); __then(); }, true)); } ; })(function __$__2() { _(null, null, true); }); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__2() {


              progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$__2() {


          roles = roleUtils.getRoleDefinitionsWithNormalizedId(result);
  ...
  role.command("create [inputfile] [roledefinition]").description($((((((((((((((((((((((((((((((((((((("Creates a custom role in Azure RBAC. Provide either a JSON role definition file or a JSON-formatted string containing the role definition as input." + "\n     The input role definition MUST contain the following properties:") + "\n     1) DisplayName: the name of the custom role") + "\n     2) Description: a short description of the role that summarizes the access that the role grants.") + "\n     3) Actions: the set of operations to which the custom role grants access. Use \"azure provider operations show\" with operationSearchString to get the operation for Azure resource providers that can be secured using Azure RBAC. Following are some valid operation strings") + "\n       - \"*/read\" grants access to read operations of all Azure resource providers.") + "\n       - \"Microsoft.Network/*/read\" grants access to read operations for all resource types in the Microsoft.Network resource provider of Azure.") + "\n       - \"Microsoft.Compute/virtualMachines/*\" grants access to all operations of virtual machines and its child resource types.") + "\n     4) AssignableScopes: the set of scopes (Azure subscriptions or resource groups) in which the custom role will be available for assignment. Using AssignableScopes you can make the custom role available for assignment in only the subscriptions or resource groups that need it, and not clutter the user experience for the rest of the subscriptions or resource groups. Following are some valid assignable scopes") + "\n       - \"/subscriptions/c276fc76-9cd4-44c9-99a7-4fd71546436e\", \"/subscriptions/e91d47c4-76f3-4271-a796-21b4ecfe3624\": makes the role available for assignment in two subscriptions.") + "\n       - \"/subscriptions/c276fc76-9cd4-44c9-99a7-4fd71546436e\": makes the role available for assignment in a single subscription.") + "\n       - \"/subscriptions/c276fc76-9cd4-44c9-99a7-4fd71546436e/resourceGroups/Network\": makes the role available for assignment only in the Network resource group.") + "\n") + "\n     The input role definition MAY contain the following properties:") + "\n     1) NotActions: the set of operations that must be excluded from the Actions to determine the effective actions for the custom role. If there is a specific operation that you do not wish to grant access to in a custom role, it is convenient to use NotActions to exclude it, rather than specifying all operations other than that specific operation in Actions.") + "\n") + "\n     NOTE: If a user is assigned a role that specifies an operation in NotActions and also assigned another role grants access to the same operation, the user will be able to perform that operation. NotActions is not a deny rule, it is simply a convenient way to create a set of allowed operations when specific operations need to be excluded.") + "\n") + "\n     Following is a sample json role definition that can be provided as input: ") + "\n     {") + "\n     \"Name\": \"Contoso On-call\",") + "\n     \"Description\": \"Can monitor compute, network and storage, and restart virtual machines\",") + "\n     \"Actions\": [") + "\n       \"Microsoft.Compute/*/read\",") + "\n       \"Microsoft.Compute/virtualMachines/start/action\",") + "\n       \"Microsoft.Compute/virtualMachines/restart/action\",") + "\n       \"Microsoft.Compute/virtualMachines/downloadRemoteDesktopConnectionFile/action\",") + "\n       \"Microsoft.Network/*/read\",") + "\n       \"Microsoft.Storage/*/read\",") + "\n       \"Microsoft.Authorization/*/read\",") + "\n       \"Microsoft.Resources/subscriptions/resourceGroups/read\",") + "\n       \"Microsoft.Resources/subscriptions/resourceGroups/resources/read\",") + "\n       \"Microsoft.Insights/alertRules/*\",") + "\n       \"Microsoft.Support/*\"") + "\n     ],") + "\n     \"AssignableScopes\": [\"/subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx\",\"/subscriptions/yyyyyyyy-yyyy-yyyy-yyyy-yyyyyyyyyyyy\"]") + "\n     }"))).usage((("[inputfile] [roledefinition]" + "\n     --------------------------  Create using JSON file  --------------------------") + "\n     azure role create --inputfile C:\\Temp\\roleDefinition.json")).option("-f --inputfile <inputfile>", $("File name containing a single role definition.")).option("-r --roledefinition <roledefinition>", $("A JSON-formatted string containing the role definition.")).option("--subscription <subscription>", $("The subscription identifier")).execute(function __3(inputfile, roledefinition, options, _) { var roleToCreate, parameters, scope, subscription, authzClient, roleDefinitionIdGuid, doneMessage, roleDef; var __frame = { name: "__3", line: 173 }; return __func(_, this, arguments, __3, 3, __frame, function __$__3() {
      ...
      roleDef = null;
      return cli.interaction.withProgress(util.format($("Creating role definition \"%s\""), roleDefinitionIdGuid), function __1(log, _) { var __frame = { name: "__1", line: 193 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
  ...
  role.command("set [inputfile] [roledefinition]").description($(((((((((((((("Modifies a custom role in Azure RBAC. Provide the modified role definition either as a JSON file or as a JSON-formatted string containing the role definition." + "\n     The role definition for the updated custom role MUST contain the Id property. The role definition SHOULD contain at least one property that is being updated: DisplayName, Description, Actions, NotActions, AssignableScopes.") + "\n") + "\n     Following is a sample updated role definition json that can be provided as input:") + "\n") + "\n     {") + "\n     \"Id\": \"52a6cc13-ff92-47a8-a39b-2a8205c3087e\",") + "\n     \"Description\": \"Can monitor all resources and start and restart virtual machines\",") + "\n     \"Actions\": [") + "\n       \"*/read\",") + "\n       \"Microsoft.ClassicCompute/virtualmachines/restart/action\",") + "\n       \"Microsoft.ClassicCompute/virtualmachines/start/action\"") + "\n     ]") + "\n     }"))).usage((("[inputfile] [roledefinition]" + "\n     --------------------------  Create using JSON file  --------------------------") + "\n     azure role set --inputfile C:\\Temp\\roleDefinition.json")).option("-f --inputfile <inputfile>", $("File name containing a single role definition to be updated. Only include the properties that are to be updated in the JSON. Id property is Required.")).option("-r --roledefinition <roledefinition>", $("A JSON-formatted string containing the role definition. For e.g. {\"Id\": \"52a6cc13-ff92-47a8-a39b-2a8205c3087e\",\"Description\": \"Updated role\",\"Actions\": [\"Microsoft.Support/*/read\"],\"Notactions\": [],\"AssignableScopes\": [\"/subscriptions/5004a9fd-d58e-48dc-aeb2-4a4aec58606f\"]}")).option("--subscription <subscription>", $("The subscription identifier")).execute(function __4(inputfile, roledefinition, options, _) { var inputRole, subscription, authzClient, progress, getResult, parameters, scope, roleDefinitionIdGuid, doneMessage, roleDef; var __frame = { name: "__4", line: 229 }; return __func(_, this, arguments, __4, 3, __frame, function __$__4() {
      ...
      subscription = profile.current.getSubscription(options.subscription);
      authzClient = rbacClients.getAuthzClient(subscription);
      progress = cli.interaction.progress($("Getting role definition"));
      getResult = null; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__4() {

            return authzClient.roleDefinitions.get(inputRole.id, __cb(_, __frame, 16, 46, function ___(__0, __2) { getResult = __2.roleDefinition; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__4() {

              progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$__4() {


          if (!getResult) {
            return _(new Error(util.format($("Cannot find roledefinition with id: %s"), inputRole.id))); } ;


          parameters = roleUtils.constructRoleDefinitionUpdateParameters(cli, inputRole, getResult);
          scope = parameters.roleDefinition.properties.assignableScopes[0];
          roleDefinitionIdGuid = parameters.roleDefinition.name;
          doneMessage = util.format($("Updated role definition %s"), roleDefinitionIdGuid);

          roleDef = null;
          return cli.interaction.withProgress(util.format($("Updating role definition \"%s\""), roleDefinitionIdGuid), function __1(log, _) { var __frame = { name: "__1", line: 261 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
  ...
  role.command("delete [id] [name]").description($("Deletes a custom role in Azure RBAC. The role to be deleted is specified using the Id or Name property of the role. Delete will fail if there are existing role assignments made to the custom role.")).usage((((((("[id] [name]" + "\n") + "\n     --------------------------  Example 1  --------------------------") + "\n     azure role delete --name \"Contoso On-call\"") + "\n") + "\n     --------------------------  Example 2  --------------------------") + "\n     azure role delete --id \"52a6cc13-ff92-47a8-a39b-2a8205c3087e\"")).option("--id <id>", $("Id of the Role definition to be deleted")).option("-n --name <name>", $("Name of the Role definition to be deleted.")).option("-q --quiet", $("If set, does not prompt for a confirmation before deleting the custom role")).option("--passthru", $("If set, displays the properties of deleted custom role")).option("--subscription <subscription>", $("The subscription identifier")).execute(function __5(id, name, options, _) { var subscription, client, role, progress, scope, roleDefinition, filterParameters, roles, deleteResult; var __frame = { name: "__5", line: 290 }; return __func(_, this, arguments, __5, 3, __frame, function __$__5() {
      ...
      subscription = profile.current.getSubscription(options.subscription);
      client = rbacClients.getAuthzClient(subscription);
      role = (name ? name : id); return (function __$__5(_) {

        var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete role definition \"%s\"? [y/n] "), role), __cb(_, __frame, 11, 43, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -289, 17, function ___(__0, __2) { return (function __$__5(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$__5() { return (function __$__5(__then) {
            ...
            if (id) {
              return client.roleDefinitions.get(id, __cb(_, __frame, 19, 50, function ___(__0, __3) { roleDefinition = __3.roleDefinition;
                ...
                scope = roleDefinition.properties.assignableScopes[0]; __then(); }, true)); } else {


              filterParameters = { roleName: name };
              return client.roleDefinitions.listWithFilters(filterParameters, __cb(_, __frame, 32, 41, function ___(__0, __4) { roles = __4.roleDefinitions;
                ...
                id = roles[0].name;
                scope = roles[0].properties.assignableScopes[0];
                progress = cli.interaction.progress(util.format($("Deleting role definition with name \"%s\""), name)); __then(); }, true)); } ; })(function __$__5() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__5() {
                  ...
                  return client.roleDefinitions.deleteMethod(id, scope, __cb(_, __frame, 49, 44, function ___(__0, __5) { deleteResult = __5; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__5() {
