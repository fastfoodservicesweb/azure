...
exports.init = function(cli) {
                    ...
                    if (options.resourceGroup) {
                      return insightsCommand._prepareAndExecute(options.resourceGroup, "resourceGroup", "resourceGroupName", options, __cb(_, __frame, 10, 26, __then, true)); } else { return (function __$__1(__then) {
                        if (options.resourceId) {
                          return insightsCommand._prepareAndExecute(options.resourceId, "resourceId", "resourceUri", options, __cb(_, __frame, 12, 26, __then, true)); } else {
  ...
  insightsCommand._prepareAndExecuteSimple = function insightsCommand__prepareAndExecuteSimple__2(options, _) { var client, queryFilter, __this = this; var __frame = { name: "insightsCommand__prepareAndExecuteSimple__2", line: 72 }; return __func(_, this, arguments, insightsCommand__prepareAndExecuteSimple__2, 1, __frame, function __$insightsCommand__prepareAndExecuteSimple__2() {
  ...
  insightsCommand._executeEventsCmd = function insightsCommand__executeEventsCmd__4(client, queryFilter, selectedFields, keepTheRecord, options, _) { var progress, result, response, recordFilter, nextLink; var __frame = { name: "insightsCommand__executeEventsCmd__4", line: 92 }; return __func(_, this, arguments, insightsCommand__executeEventsCmd__4, 5, __frame, function __$insightsCommand__executeEventsCmd__4() {
              ...
              nextLink = response.eventDataCollection.nextLink; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$insightsCommand__executeEventsCmd__4() { __more = false;
                  var __4 = nextLink; if (__4) {
                    ...
                    return client.eventOperations.listEventsNext(nextLink, __cb(_, __frame, 15, 42, function ___(__0, __2) { response = __2;
                      __.each(response.eventDataCollection.value, recordFilter);
                      nextLink = response.eventDataCollection.nextLink; while (__more) { __loop(); }; __more = true; }, true)); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(function __$insightsCommand__executeEventsCmd__4() { _(null, null, true); }); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$insightsCommand__executeEventsCmd__4() {
