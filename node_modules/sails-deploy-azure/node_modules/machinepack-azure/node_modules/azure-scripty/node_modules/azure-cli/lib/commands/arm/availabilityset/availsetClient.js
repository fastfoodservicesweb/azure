...
__.extend(AvailsetClient.prototype, {
  createAvailSet: function createAvailSet__1(resourceGroupName, name, location, tags, options, _) { var subscription, serviceClients, params, availSetHelper, availSetResult, __this = this; var __frame = { name: "createAvailSet__1", line: 19 }; return __func(_, this, arguments, createAvailSet__1, 5, __frame, function __$createAvailSet__1() {
      ...
      return availSetHelper.getAvailSet(resourceGroupName, name, __cb(_, __frame, 11, 40, function ___(__0, __1) { availSetResult = __1;
        if (availSetResult) {
        ...
        return availSetHelper.createNewAvailSet(resourceGroupName, params, __cb(_, __frame, 16, 19, function __$createAvailSet__1() { _(); }, true)); }, true)); }); },


  listAvailSet: function listAvailSet__2(resourceGroupName, options, _) { var subscription, serviceClients, availSetHelper, availsetsResult, output, __this = this; var __frame = { name: "listAvailSet__2", line: 38 }; return __func(_, this, arguments, listAvailSet__2, 2, __frame, function __$listAvailSet__2() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      ...
      return availSetHelper.getAvailList(resourceGroupName, __cb(_, __frame, 5, 41, function ___(__0, __1) { availsetsResult = __1;
        ...
        __this.cli.interaction.formatOutput(availsetsResult.availabilitySets, function(outputData) {
  ...
  showAvailSet: function showAvailSet__3(resourceGroupName, name, options, _) { var output, isJson, depth, subscription, serviceClients, dependencies, availsetResult, availabilitySet, __this = this; var __frame = { name: "showAvailSet__3", line: 59 }; return __func(_, this, arguments, showAvailSet__3, 3, __frame, function __$showAvailSet__3() {
      ...
      return dependencies.availabilitySet.getAvailSetByNameExpanded(resourceGroupName, name, depth, { }, dependencies, __cb(_, __frame, 29, 54, function ___(__0, __1) { availsetResult = __1;
        if (availsetResult) {
          availabilitySet = availsetResult.availabilitySet;
  ...
  deleteAvailSet: function deleteAvailSet__4(resourceGroupName, name, options, _) { var subscription, serviceClients, availSetHelper, availsetResult, __this = this; var __frame = { name: "deleteAvailSet__4", line: 103 }; return __func(_, this, arguments, deleteAvailSet__4, 3, __frame, function __$deleteAvailSet__4() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      ...
      return availSetHelper.getAvailSet(resourceGroupName, name, __cb(_, __frame, 5, 40, function ___(__0, __2) { availsetResult = __2;
        if (!availsetResult) {
          ...
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return __this.cli.interaction.confirm(util.format($("Delete availability set \"%s\"? [y/n] "), name), __cb(_, __frame, 10, 48, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -102, 21, function ___(__0, __3) { return (function __$deleteAvailSet__4(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$deleteAvailSet__4() {
