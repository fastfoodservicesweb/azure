...
exports.init = function(cli) {
      ...
      clearAll = false; return (function __$__4(__then) {
        ...
        if ((!options.subscription && !options.environment)) {
          clearAll = true; return (function __$__4(_) {
            var __1 = options.quiet; if (__1) { return _(null, __1); } ; return cli.interaction.confirm($("This will clear all account information. Are you sure? [y/n] "), __cb(_, __frame, 7, 59, _, true)); })(__cb(_, __frame, -116, 18, function ___(__0, __2) { shouldClear = __2;
  ...
  if (cli.isAsmMode()) {
    account.command("import <file>").description($("Import a publishsettings file or certificate for your account")).option("--skipregister", $("skip registering resources")).execute(function __5(file, options, _) { var __frame = { name: "__5", line: 166 }; return __func(_, this, arguments, __5, 2, __frame, function __$__5() {
    ...
    account.command("download").description($("Launch a browser to download your publishsettings file")).option("-e, --environment <environment>", $("the publish settings download environment")).option("-r, --realm <realm>", $("the organization's realm, aka 'tenant'")).execute(function __6(options, _) { var url; var __frame = { name: "__6", line: 175 }; return __func(_, this, arguments, __6, 1, __frame, function __$__6() {
