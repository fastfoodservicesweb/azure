...
var FileSystemOperations = ( /** @lends FileSystemOperations */ function() {
  ...
  FileSystemOperations.prototype.append = function(fileAppendRequestLink, streamContents, callback) {
    ...
    if ('Azure SDK - Microsoft.Azure.Management.DataLake.StoreFileSystem 0.9.4-preview ' + this.client.userAgentSuffix !== null && 'Azure SDK - Microsoft.Azure.Management.DataLake.StoreFileSystem 0.9.4-preview ' + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['useragent'] = 'Azure SDK - Microsoft.Azure.Management.DataLake.StoreFileSystem 0.9.4-preview ' + this.client.userAgentSuffix;
    }
    if ('Azure SDK - Microsoft.Azure.Management.DataLake.StoreFileSystem 0.9.4-preview ' + this.client.userAgentSuffix !== null && 'Azure SDK - Microsoft.Azure.Management.DataLake.StoreFileSystem 0.9.4-preview ' + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['User-Agent'] = 'Azure SDK - Microsoft.Azure.Management.DataLake.StoreFileSystem 0.9.4-preview ' + this.client.userAgentSuffix;
    }
   ...
   * @returns {Stream} The response stream.
   */
  FileSystemOperations.prototype.conccurrentAppend = function(accountName, filePath, streamContents, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
   ...
   * location that will service the request. DO NOT USE DIRECTLY in C# (this
   * should be used directly in Node.js). Call BeginAppend and
   * BeginAppendAsync instead. This ensures proper following of WebHDFS
   * redirects
   * 
   * @param {string} filePath The path to the file to append to.
   * 
   ...
   * @returns {Stream} The response stream.
   */
  FileSystemOperations.prototype.internalBeginAppend = function(filePath, accountName, bufferSize, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
   ...
   * location that will service the request. DO NOT USE DIRECTLY in C# (This
   * should be used directly in Node.js). Call BeginCreate and
   * BeginCreateAsync instead. This ensures proper following of WebHDFS
   * redirects
   * 
   * @param {string} filePath The path to the file to create.
   * 
   ...
   * @returns {Stream} The response stream.
   */
  FileSystemOperations.prototype.internalBeginCreate = function(filePath, accountName, parametersOrCallback, callback) {
    var parameters = parametersOrCallback;
    if (_.isFunction(parameters)) {
      callback = parameters;
      parameters = null;
   ...
   * DIRECTLY in C# (in Node.js, please ONLY call this API to read/open the
   * contents of a file. DO NOT call Open). Call BeginOpen and BeginOpenAsync
   * instead. This ensures proper following of WebHDFS redirects
   * 
   * @param {string} filePath The path to the file to open.
   * 
   * @param {string} accountName The name of the account to use
   ...
   * @returns {Stream} The response stream.
   */
  FileSystemOperations.prototype.internalBeginOpen = function(filePath, accountName, parametersOrCallback, callback) {
    var parameters = parametersOrCallback;
    if (_.isFunction(parameters)) {
      callback = parameters;
      parameters = null;
