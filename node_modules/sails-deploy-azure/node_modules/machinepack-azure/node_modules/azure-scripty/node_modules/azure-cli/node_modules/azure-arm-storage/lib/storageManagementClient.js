        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (propertiesValue !== null && propertiesValue !== undefined) {
            ...
            if (primaryEndpointsValue !== null && primaryEndpointsValue !== undefined) {
              ...
              var fileValue = primaryEndpointsValue['file'];
            ...
            if (secondaryEndpointsValue !== null && secondaryEndpointsValue !== undefined) {
              ...
              var fileValue2 = secondaryEndpointsValue['file'];
              if (fileValue2 !== null && fileValue2 !== undefined) {
                var fileInstance2 = fileValue2;
...
var StorageAccountOperations = ( /** @lends StorageAccountOperations */ function() {
   ...
   * characters in length and use numbers and lower-case letters only.
   * 
   * @param {string} regenerateKey Specifies name of the key which should be
...
var UsageOperations = ( /** @lends UsageOperations */ function() {
   ...
   * instance of the [StorageManagementClient] {@link
   * StorageManagementClient~StorageManagementClient}.
   * See [usage] {@link StorageManagementClient~StorageManagementClient#usage}.
   ...
   * @returns {Stream} The response stream.
   */
  UsageOperations.prototype.list = function(callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    url2 = url2 + '/providers/Microsoft.Storage/usages';
    var queryParameters = [];
