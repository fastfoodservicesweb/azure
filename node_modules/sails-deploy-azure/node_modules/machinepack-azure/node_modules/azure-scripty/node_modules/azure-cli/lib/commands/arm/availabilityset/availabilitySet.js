...
__.extend(AvailabilitySet.prototype, {
  ...
  createAvailSetIfRequired: function createAvailSetIfRequired__1(_) { var availsetInfo, availSet, connectedVMRefs, expectedVMId, i, __this = this; var __frame = { name: "createAvailSetIfRequired__1", line: 37 }; return __func(_, this, arguments, createAvailSetIfRequired__1, 0, __frame, function __$createAvailSetIfRequired__1() {
      ...
      return __this.getAvailSet(__this.resourceGroupName, __this.params.availsetName, __cb(_, __frame, 16, 26, function ___(__0, __1) { availSet = __1;
        if (availSet) {
          if (!utils.ignoreCaseAndSpaceEquals(availSet.availabilitySet.location, __this.params.location)) {
            return _(new Error(util.format($("An Availability set with name \"%s\" already exists in another region \"%s\""), __this.params.availsetName, availSet.availabilitySet.location))); } ;


          __this.cli.output.info(util.format($("Found an Availability set \"%s\""), __this.params.availsetName));
          connectedVMRefs = availSet.availabilitySet.virtualMachinesReferences;
          if ((connectedVMRefs instanceof Array)) {
            ...
            for (i = 0; (i < connectedVMRefs.length); i++) {
              if (utils.stringEndsWith(connectedVMRefs[i].referenceUri, expectedVMId, true)) {
                return _(new Error(util.format($("A VM with name \"%s\" (reference \"%s\") is already in the availability set \"%s\""), __this.params.vmName, connectedVMRefs[i].referenceUri, __this.params.availsetName))); } ; }; } ;
  ...
  getAvailSetByIdExpanded: function getAvailSetByIdExpanded__2(referenceUri, depth, memoize, dependencies, _) { var resourceInfo, expandedAvailSet, __this = this; var __frame = { name: "getAvailSetByIdExpanded__2", line: 82 }; return __func(_, this, arguments, getAvailSetByIdExpanded__2, 4, __frame, function __$getAvailSetByIdExpanded__2() {
  ...
  getAvailSetByNameExpanded: function getAvailSetByNameExpanded__3(resourceGroupName, availsetName, depth, memoize, dependencies, _) { var availSet, expandedAvailSet, __this = this; var __frame = { name: "getAvailSetByNameExpanded__3", line: 93 }; return __func(_, this, arguments, getAvailSetByNameExpanded__3, 5, __frame, function __$getAvailSetByNameExpanded__3() {
  ...
  getAvailSet: function getAvailSet__4(resourceGroupName, availsetName, _) { var progress, availSet, __this = this; var __frame = { name: "getAvailSet__4", line: 99 }; return __func(_, this, arguments, getAvailSet__4, 2, __frame, function __$getAvailSet__4() {
  ...
  getAvailList: function getAvailList__5(resourceGroupName, _) { var availSets, progress, __this = this; var __frame = { name: "getAvailList__5", line: 114 }; return __func(_, this, arguments, getAvailList__5, 1, __frame, function __$getAvailList__5() {
  ...
  deleteAvailSet: function deleteAvailSet__6(resourceGroupName, availsetName, _) { var progress, __this = this; var __frame = { name: "deleteAvailSet__6", line: 126 }; return __func(_, this, arguments, deleteAvailSet__6, 2, __frame, function __$deleteAvailSet__6() {
  ...
  createNewAvailSet: function createNewAvailSet__7(resourceGroupName, params, _) { var createRequestProfile, progress, __this = this; var __frame = { name: "createNewAvailSet__7", line: 140 }; return __func(_, this, arguments, createNewAvailSet__7, 2, __frame, function __$createNewAvailSet__7() {
      ...
      progress = __this.cli.interaction.progress(util.format($("Creating availability set \"%s\""), params.availsetName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$createNewAvailSet__7() {
            ...
            return __this.computeManagementClient.availabilitySets.createOrUpdate(resourceGroupName, createRequestProfile, __cb(_, __frame, 4, 54, function __$createNewAvailSet__7() {
  ...
  _expandAvailSet: function _expandAvailSet__8(availSet, depth, memoize, dependencies, _) { var availabilitySet, referenceUri, i, vmReference, vmReferenceId; var __frame = { name: "_expandAvailSet__8", line: 151 }; return __func(_, this, arguments, _expandAvailSet__8, 4, __frame, function __$_expandAvailSet__8() {
      ...
      availabilitySet = availSet.availabilitySet;
      ...
      memoize[referenceUri] = availSet; return (function __$_expandAvailSet__8(__then) {
        ...
        if ((availabilitySet.virtualMachinesReferences instanceof Array)) {
          i = 0; var __3 = false; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$_expandAvailSet__8() { __more = false; if (__3) { i++; } else { __3 = true; } ; var __2 = (i < availabilitySet.virtualMachinesReferences.length); if (__2) {
                ...
                vmReferenceId = vmReference.referenceUri.toLowerCase(); return (function __$_expandAvailSet__8(__then) {
