...
exports.init = function(cli) {
  ...
  adSP.command("create <application-id>").description($("Create active directory service principal")).usage("[options] <application-id>").option("--applicationId <application-id>", $("the application Id for which service principal is created")).execute(function __3(applicationId, options, _) { var subscription, client, spParams, servicePrincipal; var __frame = { name: "__3", line: 92 }; return __func(_, this, arguments, __3, 2, __frame, function __$__3() {
      ...
      return withProgress(util.format($("Creating service principal for application %s"), applicationId), function __1(log, _) { var __frame = { name: "__1", line: 101 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {

          return client.servicePrincipal.create(spParams, __cb(_, __frame, 1, 39, function ___(__0, __2) { var __1 = __2.servicePrincipal; return _(null, __1); }, true)); }); }, __cb(_, __frame, 8, 29, function ___(__0, __2) { servicePrincipal = __2;


        adUtils.displayAServicePrincipal(servicePrincipal, log); _(); }, true)); }); });


  adSP.command("delete <object-id>").description($("Deletes active directory service principal")).usage("[options] <object-id>").option("--objectId <object-id>", $("the object id of the service principal to delete")).option("-q, --quiet", $("quiet mode (do not ask for delete confirmation)")).execute(function __4(objectId, options, _) { var subscription, client, progress; var __frame = { name: "__4", line: 113 }; return __func(_, this, arguments, __4, 2, __frame, function __$__4() {
