/*** Generated by streamline 0.10.17 (callbacks) - DO NOT EDIT ***/ "use strict"; var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename, false),__func=__rt.__func,__cb=__rt.__cb,__tryCatch=__rt.__tryCatch,__forIn=__rt.__forIn; var streams = require("streamline/lib/streams/streams");
...
exports.init = function(cli) {
  ...
  group.command("create [name] [location]").description($("Creates a new resource group")).usage("[options] <name> <location>").option("-n --name <name>", $("the resource group name")).option("-l --location <location>", $("the location where we will create the group")).option("-d --deployment-name <deployment-name>", $("the name of the deployment we will create (only valid when a template is used)")).fileRelatedOption("-f --template-file <template-file>", $("the path to the template file in the file system")).option("--template-uri <template-uri>", $("the uri to the remote template file")).option("--template-version <template-version>", $("the content version of the template")).option("-p --parameters <parameters>", $("a JSON-formatted string containing parameters")).fileRelatedOption("-e --parameters-file <parametersFile>", $("a file containing parameters")).option("-t --tags <tags>", $(("Tags to set to the resource group. Can be multiple. " + "In the format of 'name=value'. Name is required and value is optional. For example, -t tag1=value1;tag2"))).option("--subscription <subscription>", $("the subscription identifier")).execute(function __1(name, location, options, _) { var updatedGroup; var __frame = { name: "__1", line: 52 }; return __func(_, this, arguments, __1, 3, __frame, function __$__1() {
      ...
      return group.createResourceGroup(name, location, options, __cb(_, __frame, 1, 31, function ___(__0, __1) { updatedGroup = __1;
        showResourceGroup(updatedGroup); _(); }, true)); }); });


  group.command("set [name]").description($("Set tags to a resource group")).usage("[options] <name> <tags>").option("-n --name <name>", $("the resource group name")).option("-t --tags <tags>", $(("Tags to set to the resource group. Can be multiple. " + "In the format of 'name=value'. Name is required and value is optional. For example, -t tag1=value1;tag2"))).option("--no-tags", $("remove all existing tags")).option("--subscription <subscription>", $("the subscription identifier")).execute(function __2(name, options, _) { var updatedGroup; var __frame = { name: "__2", line: 65 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
      ...
      return group.createResourceGroup(name, "", options, __cb(_, __frame, 1, 31, function ___(__0, __1) { updatedGroup = __1;
        showResourceGroup(updatedGroup); _(); }, true)); }); });


  group.createResourceGroup = function group_createResourceGroup__3(name, location, options, _) { var subscription, client, existingGroup, message, doneMessage, tags, group; var __frame = { name: "group_createResourceGroup__3", line: 70 }; return __func(_, this, arguments, group_createResourceGroup__3, 3, __frame, function __$group_createResourceGroup__3() {
      subscription = profile.current.getSubscription(options.subscription);
      client = utils.createResourceClient(subscription);



      return cli.interaction.withProgress(util.format($("Getting resource group %s"), name), function __1(log, _) { var __frame = { name: "__1", line: 77 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
        ...
        return cli.interaction.withProgress(message, function __2(log, _) { var __frame = { name: "__2", line: 103 }; return __func(_, this, arguments, __2, 1, __frame, function __$__2() { return (function __$__2(__then) {
          ...
          log.info(doneMessage); return (function __$group_createResourceGroup__3(__then) {
            ...
            return _(null, group.resourceGroup); }); }, true)); }, true)); }); };


  group.command("delete [name]").description($("Deletes a resource group")).usage("[options] <name>").option("-n --name <name>", $("the resource group name")).option("-q, --quiet", $("quiet mode (do not ask for delete confirmation)")).option("--subscription <subscription>", $("the subscription identifier")).execute(function __4(name, options, _) { var subscription, client, progress; var __frame = { name: "__4", line: 133 }; return __func(_, this, arguments, __4, 2, __frame, function __$__4() { return (function __$__4(_) {
        ...
        var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete resource group %s? [y/n] "), name), __cb(_, __frame, 1, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -132, 17, function ___(__0, __2) { return (function __$__4(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$__4() {



          subscription = profile.current.getSubscription(options.subscription);
          client = utils.createResourceClient(subscription);
          progress = cli.interaction.progress(util.format($("Deleting resource group %s"), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__4() {

                return client.resourceGroups.deleteMethod(name, __cb(_, __frame, 9, 30, function __$__4() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__4() {
      ...
      if (options.tags) {
        tagUtils.populateQueryFilterWithTagInfo(options.tags, parameters); } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__5() {
            ...
            return client.resourceGroups.list(parameters, __cb(_, __frame, 12, 45, function ___(__0, __3) { response = __3;
              resourceGroups = response.resourceGroups; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$__5() { __more = false;
                  ...
                  var __8 = response.nextLink; if (__8) {
                    return client.resourceGroups.listNext(response.nextLink, __cb(_, __frame, 16, 43, function ___(__0, __4) { response = __4;
                      resourceGroups.contact(response.resourceGroups); while (__more) { __loop(); }; __more = true; }, true)); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(function __$__5() { _(null, null, true); }); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__5() {
          ...
          if (parameters.tagName) {
            resourceGroups = resourceGroups.filter(function(element) {
              return ((element.tags.hasOwnProperty(parameters.tagName)) && ((!parameters.tagValue || (parameters.tagValue === element.tags[parameters.tagName])))); }); } ; return (function __$__5(__then) {
            ...
            if (options.details) {
              progress = cli.interaction.progress($("Listing resources for the groups")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__5() {
                    ...
                    var __1 = __forIn(resourceGroups); var __2 = 0; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$__5() { __more = false; var __10 = (__2 < __1.length); if (__10) { i = __1[__2++];
                          ...
                          return client.resources.list({ resourceGroupName: resourceGroup.name }, __cb(_, __frame, 37, 55, function ___(__0, __5) { resourceGroup.resources = __5.resources;
  ...
  group.command("show [name]").description($("Shows a resource group for your subscription")).usage("[options] <name>").option("-n --name <name>", $("the resource group name")).option("--subscription <subscription>", $("the subscription identifier")).execute(function __6(name, options, _) { var subscription, client, authzClient, progress, resourceGroup; var __frame = { name: "__6", line: 232 }; return __func(_, this, arguments, __6, 2, __frame, function __$__6() {
      ...
      progress = cli.interaction.progress($("Listing resource groups")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__6() {


            return client.resourceGroups.get(name, __cb(_, __frame, 8, 46, function ___(__0, __1) { resourceGroup = __1.resourceGroup; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__6() {
          ...
          progress = cli.interaction.progress($("Listing resources for the group")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__6() {
                ...
                return client.resources.list({ resourceGroupName: name }, __cb(_, __frame, 16, 51, function ___(__0, __2) { resourceGroup.resources = __2.resources;
                  return authzClient.permissions.listForResourceGroup(name, __cb(_, __frame, 17, 60, function ___(__0, __3) { resourceGroup.permissions = __3.permissions; _(null, null, true); }, true)); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__6() {
  ...
  grouplog.command("show [name]").description($("Retrieves and shows logs for resource group operations")).option("-n --name <name>", $("the resource group name")).option("-a --all", $("returns logs for all operations (including CRUD and deployment)")).option("-l --last-deployment", $("returns logs for the last deployment")).option("-d --deployment <name>", $("the name of the deployment whose logs you want to see")).option("-s --subscription <subscription>", $("the subscription identifier")).execute(function __7(name, options, _) { var subscription, progress, logStream, logEntry, isJson, logEntrySet;
    ...
    function endProgress() {
      if (progress) {
        progress.end();
        progress = null; } ; }; var __frame = { name: "__7", line: 349 }; return __func(_, this, arguments, __7, 2, __frame, function __$__7() { if (!name) { return _(null, cli.missingArgument("name")); } ; if (([options.all,options.lastDeployment,options.deployment,].filter(function(opt) { return opt; }).length > 1)) { return _(new Error($("Must specify only one of --all, --last-deployment, or --deployment switches"))); } ; subscription = profile.current.getSubscription(options.subscription); progress = cli.interaction.progress($("Getting group logs"));
      ...
      return logStream.read(__cb(_, __frame, 31, 31, function ___(__0, __1) { logEntry = __1;
        ...
        logEntrySet = []; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$__7() { __more = false;
            ...
            var __4 = (logEntry !== null); if (__4) {
              ...
              return logStream.read(__cb(_, __frame, 44, 29, function ___(__0, __2) { logEntry = __2; while (__more) { __loop(); }; __more = true; }, true)); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(function __$__7() {
