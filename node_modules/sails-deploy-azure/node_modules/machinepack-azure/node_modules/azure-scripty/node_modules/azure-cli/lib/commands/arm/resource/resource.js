...
exports.init = function(cli) {
  ...
  resource.command("move [ids] [destination-group]").description($("Moves resources from one resource group to another")).usage("[options] <ids> <destination-group>").option("-i --ids <ids>", $("the comma-delimitied resource ids to be moved")).option("-d --destination-group <destination-group>", $("the destination resource group name")).option("-q, --quiet", $("quiet mode (do not ask for delete confirmation)")).option("--subscription <subscription>", $("the subscription identifier")).execute(function __7(ids, destinationGroup, apiVersion, options, _) { var resources, sourceGroup, subscription, client, progress, parameters; var __frame = { name: "__7", line: 315 }; return __func(_, this, arguments, __7, 4, __frame, function __$__7() {
      ...
      sourceGroup = resourceUtils.getSourceResourceGroupForMove(resources); return (function __$__7(_) {
        ...
        var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Move selected resources in %s to %s? [y/n] "), sourceGroup, destinationGroup), __cb(_, __frame, 11, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -314, 17, function ___(__0, __2) { return (function __$__7(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$__7() {
          ...
          progress = cli.interaction.progress(util.format($("Moving selected resources to %s"), destinationGroup)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__7() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__7() {
                      ...
                      parameters = {
                        targetResourceGroup: ((("/subscriptions/" + subscription.id) + "/resourceGroups/") + destinationGroup),
                        resources: resources };

                      return client.resources.moveResources(sourceGroup, parameters, __cb(_, __frame, 23, 25, __then, true)); }); })(function ___(e, __result) { __catch(function __$__7() { if (e) {
