      ...
      return adUtils.getObjectId({
        ...
        progress = cli.interaction.progress($("Finding role with specified name")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() { return (function __$__1(__then) {
                ...
                if (roleName) {
                  ...
                  return authzClient.roleDefinitions.listWithFilters(filterParameters, __cb(_, __frame, 40, 53, function ___(__0, __2) { matchedRoles = __2.roleDefinitions; __then(); }, true)); } else {


                  return authzClient.roleDefinitions.get(roleId, __cb(_, __frame, 43, 56, function ___(__0, __3) { matchedRoles.push(__3.roleDefinition); __then(); }, true)); } ; })(function __$__1() { _(null, null, true); }); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__1() {
