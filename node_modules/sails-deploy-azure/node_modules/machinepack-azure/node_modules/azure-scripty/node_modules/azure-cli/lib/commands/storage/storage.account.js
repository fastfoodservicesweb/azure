...
exports.init = function(cli) {
  ...
  function listAccounts(serviceClient, options, _) { var progress, storageAccounts; var __frame = { name: "listAccounts", line: 100 }; return __func(_, this, arguments, listAccounts, 2, __frame, function __$listAccounts() {
      progress = showProgress($("Getting storage accounts")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$listAccounts() { return (function __$listAccounts(__then) {
              ...
              if ((isResourceMode && options.resourceGroup)) {
                return serviceClient.storageAccounts.listByResourceGroup(options.resourceGroup, __cb(_, __frame, 5, 56, function ___(__0, __1) { storageAccounts = __1.storageAccounts; __then(); }, true)); } else {

                return serviceClient.storageAccounts.list(__cb(_, __frame, 7, 56, function ___(__0, __2) { storageAccounts = __2.storageAccounts; __then(); }, true)); } ; })(function __$listAccounts() { _(null, null, true); }); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$listAccounts() {
  ...
  function showAccount(serviceClient, accountName, options, _) { var progress, message, storageAccount; var __frame = { name: "showAccount", line: 116 }; return __func(_, this, arguments, showAccount, 3, __frame, function __$showAccount() {
      ...
      message = $("Getting storage account"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$showAccount() { return (function __$showAccount(__then) {
              ...
              if (isResourceMode) {
                return validateResourceGroupName(options, __cb(_, __frame, 6, 8, function __$showAccount() {
                  ...
                  return serviceClient.storageAccounts.getProperties(options.resourceGroup, accountName, __cb(_, __frame, 8, 55, function ___(__0, __1) { storageAccount = __1.storageAccount; __then(); }, true)); }, true)); } else {
  ...
  function createAccount(serviceClient, parameters, options, _) { var progress, message, storageAccount; var __frame = { name: "createAccount", line: 136 }; return __func(_, this, arguments, createAccount, 3, __frame, function __$createAccount() {
  ...
  function updateAccount(serviceClient, accountName, parameters, options, _) { var progress, message, storageAccount; var __frame = { name: "updateAccount", line: 157 }; return __func(_, this, arguments, updateAccount, 4, __frame, function __$updateAccount() {
  ...
  function deleteAccount(serviceClient, accountName, options, _) { var progress, message, storageAccount; var __frame = { name: "deleteAccount", line: 178 }; return __func(_, this, arguments, deleteAccount, 3, __frame, function __$deleteAccount() {
  ...
  function checkNameAvailability(serviceClient, accountName, _) { var progress, message, availability; var __frame = { name: "checkNameAvailability", line: 199 }; return __func(_, this, arguments, checkNameAvailability, 2, __frame, function __$checkNameAvailability() {
  ...
  function showSubscriptionUsage(serviceClient, subscriptionId, _) { var progress, message, usage, usageList, i; var __frame = { name: "showSubscriptionUsage", line: 228 }; return __func(_, this, arguments, showSubscriptionUsage, 2, __frame, function __$showSubscriptionUsage() {
      ...
      if (!subscriptionId) {
        usage.subscriptionId = profile.current.getSubscription().id; } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$showSubscriptionUsage() {
            ...
            progress = showProgress(message);
            return serviceClient.usage.list(__cb(_, __frame, 11, 42, function ___(__0, __1) { usageList = __1.usages;
  ...
  function getAccountKeys(serviceClient, accountName, options, _) { var progress, message, keys; var __frame = { name: "getAccountKeys", line: 254 }; return __func(_, this, arguments, getAccountKeys, 3, __frame, function __$getAccountKeys() {
  ...
  function regenerateAccountKeys(serviceClient, accountName, options, _) { var progress, message, keys, keyType, parameters; var __frame = { name: "regenerateAccountKeys", line: 275 }; return __func(_, this, arguments, regenerateAccountKeys, 3, __frame, function __$regenerateAccountKeys() {
  ...
  storageAccount.listCommand = function storageAccount_listCommand__1(options, _) { var service, storageAccounts; var __frame = { name: "storageAccount_listCommand__1", line: 308 }; return __func(_, this, arguments, storageAccount_listCommand__1, 1, __frame, function __$storageAccount_listCommand__1() {
  ...
  storageAccount.showCommand = function storageAccount_showCommand__2(name, options, _) { var service, storageAccount; var __frame = { name: "storageAccount_showCommand__2", line: 340 }; return __func(_, this, arguments, storageAccount_showCommand__2, 2, __frame, function __$storageAccount_showCommand__2() {
      service = createStorageManagementClient(options.subscription);
  ...
  storageAccount.createCommand = function storageAccount_createCommand__3(name, options, _) { var service, managementService, storageOptions; var __frame = { name: "storageAccount_createCommand__3", line: 379 }; return __func(_, this, arguments, storageAccount_createCommand__3, 2, __frame, function __$storageAccount_createCommand__3() {
      service = createStorageManagementClient(options.subscription);
  ...
  storageAccount.updateCommand = function storageAccount_updateCommand__4(name, options, _) { var service, storageOptions, customDomain; var __frame = { name: "storageAccount_updateCommand__4", line: 422 }; return __func(_, this, arguments, storageAccount_updateCommand__4, 2, __frame, function __$storageAccount_updateCommand__4() {
      service = createStorageManagementClient(options.subscription);
  ...
  storageAccount.deleteCommand = function storageAccount_deleteCommand__5(name, options, _) { var service; var __frame = { name: "storageAccount_deleteCommand__5", line: 460 }; return __func(_, this, arguments, storageAccount_deleteCommand__5, 2, __frame, function __$storageAccount_deleteCommand__5() {
      service = createStorageManagementClient(options.subscription); return (function __$storageAccount_deleteCommand__5(_) {

        var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete storage account %s? [y/n] "), name), __cb(_, __frame, 3, 43, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -459, 18, function ___(__0, __2) { return (function __$storageAccount_deleteCommand__5(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$storageAccount_deleteCommand__5() {
  ...
  storageAccount.checkCommand = function storageAccount_checkCommand__6(name, options, _) { var service, availability; var __frame = { name: "storageAccount_checkCommand__6", line: 470 }; return __func(_, this, arguments, storageAccount_checkCommand__6, 2, __frame, function __$storageAccount_checkCommand__6() {
  ...
  usage.usageCommand = function usage_usageCommand__7(subscription, options, _) { var service, usage; var __frame = { name: "usage_usageCommand__7", line: 485 }; return __func(_, this, arguments, usage_usageCommand__7, 2, __frame, function __$usage_usageCommand__7() {
  ...
  keys.listCommand = function keys_listCommand__8(name, options, _) { var service, keys; var __frame = { name: "keys_listCommand__8", line: 496 }; return __func(_, this, arguments, keys_listCommand__8, 2, __frame, function __$keys_listCommand__8() {
      service = createStorageManagementClient(options.subscription);
  ...
  keys.renewCommand = function keys_renewCommand__9(name, options, _) { var service, keys; var __frame = { name: "keys_renewCommand__9", line: 518 }; return __func(_, this, arguments, keys_renewCommand__9, 2, __frame, function __$keys_renewCommand__9() {
      service = createStorageManagementClient(options.subscription);
  ...
  connectionString.showCommand = function connectionString_showCommand__10(name, options, _) { var service, keys, connection; var __frame = { name: "connectionString_showCommand__10", line: 546 }; return __func(_, this, arguments, connectionString_showCommand__10, 2, __frame, function __$connectionString_showCommand__10() {
      service = createStorageManagementClient(options.subscription);
