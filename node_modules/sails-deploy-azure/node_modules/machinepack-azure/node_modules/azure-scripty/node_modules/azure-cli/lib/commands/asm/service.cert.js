...
exports.init = function(cli) {
  ...
  certificates.command("create <dns-name> <file> [password]").usage("[options] <dns-name> <file> [password]").description($("Upload certificate")).option("-s, --subscription <id>", $("the subscription id")).execute(function __2(dnsName, file, password, options, _) { var dnsPrefix, service, certificateOptions, progress; var __frame = { name: "__2", line: 108 }; return __func(_, this, arguments, __2, 4, __frame, function __$__2() {
      ...
      progress = cli.interaction.progress($("Creating certificate")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {
            ...
            return service.serviceCertificates.create(dnsPrefix, certificateOptions, __cb(_, __frame, 18, 36, function __$__2() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__2() {
      ...
      return getCertificates(dnsPrefix, options, __cb(_, __frame, 8, 25, function ___(__0, __2) { certificates = __2;
        ...
        certificates = certificates.filter(function(certificate) {
          ...
          if ((certificates && (certificates.length > 0))) { return (function __$__3(_) {
              var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete certificate with thumbprint %s? [y/n] "), thumbprint), __cb(_, __frame, 15, 47, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -136, 18, function ___(__0, __3) { return (function __$__3(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$__3() {
                ...
                progress = cli.interaction.progress($("Deleting certificates")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
                      ...
                      return async.each(certificates, function(certificate, callback) {
                        service.serviceCertificates.delete(certificate, callback); }, __cb(_, __frame, 22, 16, function __$__3() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__3() {
