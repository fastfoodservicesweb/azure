...
exports.init = function(cli) {
  ...
  cli.command("login").description($("Log in to an Azure subscription using Active Directory or a Microsoft account identity.")).option("-u --username <username>", $(("user name or service principal ID. If multifactor authentication is" + " required, you will be prompted to use the login command without parameters for interactive support."))).option("-e --environment [environment]", $("Environment to authenticate against, such as AzureChinaCloud; must support active directory.")).option("-p --password <password>", $("user password or service principal key, will prompt if not given.")).option("--service-principal", $("If given, log in as a service principal rather than a user.")).option("--tenant <tenant>", $("Tenant domain or ID to log into.")).option("-q --quiet", $("do not prompt for confirmation of PII storage.")).execute(function __1(options, _) { var piiWarningText, interactive, environmentName, environment, tenant, haveSeenBefore, password, progress, loginType, result, authObject, account, newSubscriptions, defaultSubscription; var __frame = { name: "__1", line: 47 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
      ...
      tenant = options.tenant; return (function __$__1(__then) {
        if (options.servicePrincipal) {
          return cli.interaction.promptIfNotGiven("Tenant: ", options.tenant, __cb(_, __frame, 19, 33, function ___(__0, __1) { tenant = __1; __then(); }, true)); } else { __then(); } ; })(function __$__1() { return (function __$__1(__then) {
          ...
          if (!tokenCache.isSecureCache) {
            haveSeenBefore = __.values(profile.current.subscriptions).some(function(s) {
              ...
              if ((!options.quiet && !haveSeenBefore)) {
                return cli.interaction.confirm(util.format(piiWarningText, profile.defaultProfileFile), __cb(_, __frame, 28, 31, function ___(__0, __3) { var __2 = !__3; return (function __$__1(__then) { if (__2) {
                      log.info($("Login cancelled")); return _(null); } else { __then(); } ; })(__then); }, true)); } else { __then(); } ; })(__then); } else { __then(); } ; })(function __$__1() {





          password = options.password; return (function __$__1(__then) {
            if ((!interactive && !options.password)) {
              return cli.interaction.promptPasswordOnceIfNotGiven("Password: ", options.password, __cb(_, __frame, 37, 35, function ___(__0, __4) { password = __4; __then(); }, true)); } else { __then(); } ; })(function __$__1() {
            ...
            progress = cli.interaction.progress($("Authenticating...")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() { return (function __$__1(__then) {
                          ...
                          if (!interactive) {
                            return adalAuth.removeCachedToken(options.username, __cb(_, __frame, 43, 19, __then, true)); } else { __then(); } ; })(function __$__1() {
                          ...
                          account = new Account(environment, authObject, resourceClient, log); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {

                                return account.load(options.username, password, tenant, loginType, __cb(_, __frame, 53, 27, function ___(__0, __5) { result = __5; __then(); }, true)); }); })(function ___(ex, __result) { __catch(function __$__1() { if (ex) {
                              ...
                              if ((newSubscriptions.length > 0)) {
                                ...
                                log.info(util.format($("No subscriptions found for this account"))); } ; __then(); }); }); }); }); })(function ___(e, __result) { __catch(function __$__1() { if (e) {
  ...
  cli.command("logout [username]").description($("Log out from Azure subscription using Active Directory. Currently, the user can log out only via Microsoft organizational account")).option("-u --username <username>", $("Required. User name used to log out from Azure Active Directory.")).execute(function __2(username, options, _) { var __frame = { name: "__2", line: 137 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
