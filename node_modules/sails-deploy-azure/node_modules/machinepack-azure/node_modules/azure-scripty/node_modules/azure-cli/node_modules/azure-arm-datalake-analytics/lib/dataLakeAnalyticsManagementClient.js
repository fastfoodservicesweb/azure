...
var DataLakeAnalyticsManagementClient = ( /** @lends DataLakeAnalyticsManagementClient */ function() {
  ...
  DataLakeAnalyticsManagementClient.prototype.getLongRunningOperationStatus = function(azureAsyncOperation, callback) {
    ...
    // Set Headers
    httpRequest.headers['x-ms-version'] = '2015-10-01-preview';
...
var DataLakeAnalyticsAccountOperations = ( /** @lends DataLakeAnalyticsAccountOperations */ function() {
  ...
  DataLakeAnalyticsAccountOperations.prototype.addDataLakeStoreAccount = function(resourceGroupName, accountName, dataLakeStoreAccountName, parametersOrCallback, callback) {
    ...
    if ('Azure SDK - Microsoft.Azure.Management.DataLake.Analytics 0.9.4-preview' + this.client.userAgentSuffix !== null && 'Azure SDK - Microsoft.Azure.Management.DataLake.Analytics 0.9.4-preview' + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['useragent'] = 'Azure SDK - Microsoft.Azure.Management.DataLake.Analytics 0.9.4-preview' + this.client.userAgentSuffix;
    }
    if ('Azure SDK - Microsoft.Azure.Management.DataLake.Analytics 0.9.4-preview' + this.client.userAgentSuffix !== null && 'Azure SDK - Microsoft.Azure.Management.DataLake.Analytics 0.9.4-preview' + this.client.userAgentSuffix !== undefined) {
      httpRequest.headers['User-Agent'] = 'Azure SDK - Microsoft.Azure.Management.DataLake.Analytics 0.9.4-preview' + this.client.userAgentSuffix;
    }
